...
import '../Report/Excel_Tax_Report.dart';
...
class Report2Screen1 extends StatefulWidget {
  const Report2Screen1({super.key});

  @override
  State<Report2Screen1> createState() => _Report2Screen1State();
}

class _Report2Screen1State extends State<Report2Screen1> {
...
///////////--------------------------------------------->(รายงานการเคลื่อนไหวธนาคาร)
  Future<Null> red_Trans_billMovemen() async {
    ...
    String url_Daily = (zone_ser_Trans_Daily.toString() == '0')
        ? '${MyConstant().domain}/GC_bill_pay_BC_Bank_DailyReport_All.php?isAdd=true&ren=$ren&date=$Value_TransDate_Daily&serzone=$zone_ser_Trans_Daily&seruser=$user_ser_Trans_Daily&ser_in=$TypeIncome_ser'
        : '${MyConstant().domain}/GC_bill_pay_BC_Bank_DailyReport.php?isAdd=true&ren=$ren&date=$Value_TransDate_Daily&serzone=$zone_ser_Trans_Daily&seruser=$user_ser_Trans_Daily&ser_in=$TypeIncome_ser';
...
///////////--------------------------------------------->()
  ...
  Future<Null> red_Trans_selectIncomeAll() async {
    ...
    String url = (Value_Report == 'รายงานการเคลื่อนไหวธนาคาร' ||
        ...
        ? '${MyConstant().domain}/GC_bill_pay_historyselectBankAllReport.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$serzone_s&datex=$Value_TransDate_Daily&Typesearch=$Type_search&seruser=$seruser_s&ser_in=$TypeIncome_ser'
        : '${MyConstant().domain}/GC_bill_pay_historyselectAllReport.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$serzone_s&datex=$Value_TransDate_Daily&Typesearch=$Type_search&seruser=$seruser_s&ser_in=$TypeIncome_ser';
    // print(
