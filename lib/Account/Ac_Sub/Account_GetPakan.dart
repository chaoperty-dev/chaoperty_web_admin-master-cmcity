...
class Account_GetPakan extends StatefulWidget {
  @override
  _Account_GetPakanState createState() => _Account_GetPakanState();
}

class _Account_GetPakanState extends State<Account_GetPakan> {
...
////////////----------------------------------->
  void addAcListTitle() {
    setState(() {
      ...
      ac10_1.addAll(
          AcListTitle().ac10_1); // Use addAll to add the contents of the list
    });
  }
...
/////////--------------------------------------------->
  ...
  Future<Null> AddDaTa() async {
    ...
    if (contractxPakanModels.isNotEmpty) {
      ...
      setState(() {
        data = List.generate(contractxPakanModels.length, (index) {
          // Ensure that docno exists and is not null
          final docno = contractxPakanModels[index].docno;
          final cid = contractxPakanModels[index].cid ?? "";
          final zn = contractxPakanModels[index].zn ?? "";
          final ln = contractxPakanModels[index].ln ?? "";
          final cname = contractxPakanModels[index].cname ??
              contractxPakanModels[index].remark ??
              "";
          final sname = contractxPakanModels[index].sname ??
              contractxPakanModels[index].remark ??
              "";
          final refno = contractxPakanModels[index].refno ?? "";
          final expname = contractxPakanModels[index].expname ?? "";
          final total = (contractxPakanModels[index].total == null ||
                  contractxPakanModels[index].total.toString() == '')
              ? '0.00'
              : nFormat
                  .format(double.parse('${contractxPakanModels[index].total}'));
          final pdatex = (contractxPakanModels[index].pdate == null ||
                  contractxPakanModels[index].pdate! == '0000-00-00')
              ? '-'
              : '${DateFormat('dd-MM').format(DateTime.parse('${contractxPakanModels[index].pdate} 00:00:00'))}-${DateTime.parse('${contractxPakanModels[index].pdate} 00:00:00').year + 0}';
          final status = contractxPakanModels[index].st ?? "";
          return {
            "index": "$index",
            if (where_ac5("0") == false) "เลขที่ใบเสร็จ": "$docno",
            if (where_ac5("1") == false) "เลขที่สัญญา": "$cid",
            if (where_ac5("2") == false) "โซนพื้นที่": "$zn",
            if (where_ac5("3") == false) "รหัสพื้นที่": "$ln",
            if (where_ac5("4") == false) "ชื่อผู้เช่า": "$cname",
            if (where_ac5("5") == false) "ชื่อร้านค้า": "$sname",
            if (where_ac5("6") == false) "เลขตั้งหนี้": "$refno",
            if (where_ac5("7") == false) "รายการ": "$expname",
            if (where_ac5("8") == false) "วันที่รับชำระ": "$pdatex",
            if (where_ac5("9") == false) "สถานะ": "$status",
            if (where_ac5("10") == false) "ยอดสุทธิ": "$total",
          };
        });
        filteredData = data;
      });
                      ...
                      child: Container(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton2<String>(
                            ...
                            items: ac10_1.asMap().entries.map((entry) {
                              ...
                              return DropdownMenuItem<String>(
                                ...
                                child: StatefulBuilder(
                                  builder: (context, menuSetState) {
                                    ...
                                    return InkWell(
                                      onTap: () {
                                        int selectedIndex = ac10_1.indexWhere(
                                            (items) =>
                                                items["ser"] == item["ser"]);
                                        ...
                                        setState(() {
                                          if (item["st"]! == '1') {
                                            ac10_1[selectedIndex]["st"] = '0';
                                          } else {
                                            ac10_1[selectedIndex]["st"] = '1';
                                          }
                                        });
                                        AddDaTa();
                                                ...
                                                Align(
                                                  ...
                                                  child: AutoSizeText(
                                                    ...
                                                    (contractxPakanModels[index]
                                                            ...
                                                            null)
                                                        ? 'อ้างอิง : -'
                                                        : 'อ้างอิง : ${contractxPakanModels[index].ref1}',
                                                    maxLines: 2,
                                                ...
                                                Align(
                                                  ...
                                                  child: AutoSizeText(
                                                    ...
                                                    (contractxPakanModels[index]
                                                            ...
                                                            null)
                                                        ? 'Ref1 : -'
                                                        : 'Ref1 : ${contractxPakanModels[index].ref2}',
                                                    maxLines: 2,
                                                    textAlign: TextAlign.left,
                                                    style: const TextStyle(
                                                        color:
                                                ...
                                                Align(
                                                  ...
                                                  child: AutoSizeText(
                                                    ...
                                                    (contractxPakanModels[index]
                                                            ...
                                                            null)
                                                        ? 'Ref2 : -'
                                                        : 'Ref2 : ${contractxPakanModels[index].ref4}',
                                                    maxLines: 2,
                                                    textAlign: TextAlign.left,
                                                    style: const TextStyle(
                                                        color:
