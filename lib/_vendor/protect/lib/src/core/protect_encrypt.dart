...
ProtectResponse _encrypt(Uint8List data, String password) {
  ...
  final encryptionInfo = {
    ...
    'key': {
      ...
      'hashSize': 64,
      'blockSize': 16,
      // 🔧 PATCHED: 100000 → 10000 (~3s instead of ~30s on web)
      // Format ยัง compatible กับ Excel password-protected xlsx (spinCount เป็น UInt32 ใน metadata)
      // Security: 10K SHA-512 iterations ยังต้าน GPU brute-force ได้ (strong password = centuries)
      'spinCount': 10000,
      'keyBits': 256,
    }
  };
