...
class Pdfgen_credit_note_TP10 {
//////////---------------------------------------------------->(ใบลดหนี้)   ใช้  //

  static void exportPDF_creditnote_TP10(
      Cust_no,
      cid_s,
      Zone_s,
      Ln_s,
    ...
    pw.Widget Sub() {
      return pw.Column(
        children: [
                  ...
                  child: pw.Container(
                      ...
                      child: pw.Column(
                          ...
                          children: [
                            ...
                            pw.Text(
                              ' ' * 5 +
                                  '- มูลค่าเอกสารเดิม : ${nFormat.format(double.parse(total_bill_befor.toString()))}',
                              textAlign: pw.TextAlign.left,
                              style: pw.TextStyle(
                                fontSize: font_Size,
                                font: ttf,
                            ...
                            pw.Text(
                              ' ' * 5 +
                                  '- มูลค่าที่ถูกต้อง : ${nFormat.format(double.parse(total_bill_befor.toString()) - double.parse(Total.toString()) + double.parse(sum_fee.toString()))}',
                              textAlign: pw.TextAlign.left,
                              style: pw.TextStyle(
                                fontSize: font_Size,
                                font: ttf,
                            ...
                            pw.Text(
                              ' ' * 5 +
                                  '- ผลต่าง : ${nFormat.format(double.parse(total_bill_befor.toString()) - (double.parse(total_bill_befor.toString()) - double.parse(Total.toString()) + double.parse(sum_fee.toString())))}',
                              textAlign: pw.TextAlign.left,
                              style: pw.TextStyle(
                                fontSize: font_Size,
                                font: ttf,
          ...
          pw.SizedBox(height: 14.3 * PdfPageFormat.mm),
          // pw.Align(
                                          ...
                                          (TitleType_Default_Receipt_Name !=
                                              ...
                                              ? (numdoctax.toString() == '')
                                                  ...
                                                  : (TitleType_Default_Receipt_Name
                                                              .toString() ==
                                                          'ต้นฉบับ')
                                                      ? 'Credit Note/Tax Invoice Original'
                                                      : (TitleType_Default_Receipt_Name
                                                                  .toString() ==
                                                              'คู่ฉบับ')
                                                          ? 'Credit Note/Tax Invoice Duplicate'
                                                          : (TitleType_Default_Receipt_Name
                                                                      .toString() ==
                                                                  'สำเนาคู่ฉบับ')
                                                              ? 'Credit Note/Tax Invoice Duplicate Copy'
                                                              : (TitleType_Default_Receipt_Name
                                                                          .toString() ==
                                                                      'สำเนา')
                                                                  ? 'Credit Note/Tax Invoice Copy'
                                          ...
                                          (TitleType_Default_Receipt_Name !=
                                              ...
                                              ? (numdoctax.toString() == '')
                                                  ...
                                                  : (TitleType_Default_Receipt_Name
                                                              .toString() ==
                                                          'ต้นฉบับ')
                                                      ? 'Credit Note/Tax Receipt Original'
                                                      : (TitleType_Default_Receipt_Name
                                                                  .toString() ==
                                                              'คู่ฉบับ')
                                                          ? 'Credit Note/Tax Receipt Duplicate'
                                                          : (TitleType_Default_Receipt_Name
                                                                      .toString() ==
                                                                  'สำเนาคู่ฉบับ')
                                                              ? 'Credit Note/Tax Receipt Duplicate Copy'
                                                              : (TitleType_Default_Receipt_Name
                                                                          .toString() ==
                                                                      'สำเนา')
                                                                  ? 'Credit Note/Tax Invoice Copy'
                                  ...
                                  child: pw.Align(
                                    ...
                                    child: pw.Text(
                                      (tableData00[index][18].toString() ==
                                              'INV')
                                          ? '${tableData00[index][2]}' +
                                              ' / ${(tableData00[index][11] == null) ? '' : tableData00[index][11]}'
