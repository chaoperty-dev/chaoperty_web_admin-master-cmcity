...
class Pdfgen_credit_notel_TP9_Lao {
//////////---------------------------------------------------->(ใบลดหนี้/ใบกำกับภาษี)   ใช้  //

  static void exportPDF_creditnote_TP9_Lao(
      Cust_no,
      cid_s,
      Zone_s,
      Ln_s,
                                              ...
                                              (TitleType_Default_Receipt_Name !=
                                                  ...
                                                  ? (numdoctax.toString() == '')
                                                      ...
                                                      : (TitleType_Default_Receipt_Name
                                                                  .toString() ==
                                                              'ต้นฉบับ')
                                                          ? 'ບັນທຶກສິນເຊື່ອ/ໃບເກັບພາສີ [ ຕົ້ນສະບັບ ]'
                                                          : (TitleType_Default_Receipt_Name
                                                                      .toString() ==
                                                                  'คู่ฉบับ')
                                                              ? 'ບັນທຶກສິນເຊື່ອ/ໃບເກັບພາສີ [ ຊໍ້າກັນ ]'
                                                              : (TitleType_Default_Receipt_Name
                                                                          .toString() ==
                                                                      'สำเนาคู่ฉบับ')
                                                                  ? 'ບັນທຶກສິນເຊື່ອ/ໃບເກັບພາສີ [ ສຳເນົາຊໍ້າກັນ ]'
                                                                  : 'ບັນທຶກສິນເຊື່ອ/ໃບເກັບພາສີ [ ສຳເນົາ ]'
                                                                      'ບັນທຶກສິນເຊື່ອ/ໃບເກັບພາສີ'
                                                  : (numdoctax.toString() == '')
                                                      ? 'ບັນທຶກສິນເຊື່ອ'
                                                      : 'ບັນທຶກສິນເຊື່ອ/ໃບເກັບພາສີ',
                          ...
                          children: [
                            ...
                            pw.Expanded(
                              ...
                              child: pw.Container(
                                ...
                                padding: const pw.EdgeInsets.all(2.0),
                                child: pw.Text(
                                  '${nFormat.format(double.parse(total_bill_befor.toString()))}',
                          ...
                          children: [
                            ...
                            pw.Expanded(
                              ...
                              child: pw.Container(
                                ...
                                padding: const pw.EdgeInsets.all(2.0),
                                child: pw.Text(
                                  '${nFormat.format(double.parse(total_bill_befor.toString()) - double.parse(Total.toString()) + double.parse(sum_fee.toString()))}',
                                  // '${nFormat.format(double.parse(Total.toString()) - double.parse(dis_sum_Matjum.toString()) - double.parse(dis_sum_Pakan.toString()))}',
                                  textAlign: pw.TextAlign.right,
                                  style: pw.TextStyle(
                                      fontSize: font_Size,
                          ...
                          children: [
                            ...
                            pw.Expanded(
                              ...
                              child: pw.Container(
                                ...
                                padding: const pw.EdgeInsets.all(2.0),
                                child: pw.Text(
                                  '${nFormat.format(double.parse(total_bill_befor.toString()) - (double.parse(total_bill_befor.toString()) - double.parse(Total.toString()) + double.parse(sum_fee.toString())))}',
                                  // '${nFormat.format(double.parse(Total.toString()) - double.parse(dis_sum_Matjum.toString()) - double.parse(dis_sum_Pakan.toString()))}',
                                  textAlign: pw.TextAlign.right,
                                  style: pw.TextStyle(
                                      fontSize: font_Size,
