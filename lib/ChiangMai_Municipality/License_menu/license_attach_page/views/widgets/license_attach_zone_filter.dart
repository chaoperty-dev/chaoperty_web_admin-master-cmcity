...
class _LicenseRequestZoneFilterState extends State<LicenseAttachZoneFilter> {
  ...
  Widget _sortSection(LicenseAttachViewModel vm) {
  ...
  void _showSortMenu(LicenseAttachViewModel vm) {
    final isDesc = vm.selectedSortDir == 'desc';
    showDialog(
      context: context,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ...LicenseAttachViewModel.sortOptions.map((k) => InkWell(
                        onTap: () {
                          vm.onSortChanged(k);
                          Navigator.of(ctx).pop();
                        },
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: AutoSizeText(
                                  LicenseAttachViewModel.sortLabels[k] ?? k,
