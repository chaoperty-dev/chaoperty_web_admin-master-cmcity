...
// ============================================================================
// Step 2 — สรุปการแนบเอกสาร (Empty page — skeleton)
// ============================================================================
...
class AttachDetailStep2 extends StatelessWidget {
            ...
            children: [
              Container(
                ...
                child: const Row(
                  children: [
                    ...
                    SizedBox(width: 8),
                    Text('สรุปการแนบเอกสาร', style: LaText.h2),
                  ],
                ),
              ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: LaSpace.md),
                    Text('เนื้อหา Step 2 — สรุปการแนบเอกสาร',
                        style: LaText.h2, textAlign: TextAlign.center),
                    const SizedBox(height: LaSpace.sm),
                    Text(
                      'พื้นที่สำหรับแสดงรายการเอกสารที่แนบ และบันทึก\n'
              ...
              const Row(
                children: [
                  ...
                  SizedBox(width: 6),
                  Expanded(
                    child: Text('เมื่อแนบเอกสารครบ กดปุ่ม "บันทึก" ด้านล่าง',
                        style: LaText.caption),
                  ),
                ],
              ),
