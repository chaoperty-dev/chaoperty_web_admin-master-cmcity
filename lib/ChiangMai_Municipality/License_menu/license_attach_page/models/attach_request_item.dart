...
//
// ตัว model นี้เป็น "ของตัวเอง" ของ license_attach_page
// (ไม่แชร์กับ fact_check / submit_approval / verify_attachment / payment)
//
...
class AttachRequestModule {
  final String code;
  final String nameTh;
  const AttachRequestModule({this.code = '', this.nameTh = ''});

  factory AttachRequestModule.fromJson(Map<String, dynamic> json) =>
      AttachRequestModule(
...
class AttachRequestCustomer {
  ...
  factory AttachRequestCustomer.fromJson(Map<String, dynamic> json) =>
...
class AttachRequestDetails {
  ...
  factory AttachRequestDetails.fromJson(Map<String, dynamic> json) =>
...
/// 1 แถวรายการ — list v2
class AttachRequestItem {
  final String uuid;
  final AttachRequestModule module;
  final AttachRequestCustomer? customer; // nullable ใน v2
  final AttachRequestDetails details;
  final String status;
  ...
  const AttachRequestItem({
    this.uuid = '',
    this.module = const AttachRequestModule(),
    this.customer,
    this.details = const AttachRequestDetails(),
    this.status = '',
    this.feeAmount = '',
  ...
  factory AttachRequestItem.fromJson(Map<String, dynamic> json) {
...
class AttachRequestsListResult {
  final List<AttachRequestItem> items;
  ...
  const AttachRequestsListResult({
    required this.items,
  ...
  static const empty = AttachRequestsListResult(
    items: [],
    currentPage: 0,
    lastPage: 0,
    perPage: 0,
