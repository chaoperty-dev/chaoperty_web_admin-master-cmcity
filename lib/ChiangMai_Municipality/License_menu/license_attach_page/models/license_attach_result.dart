// ============================================================================
// license_attach_result.dart
// ============================================================================
// ผลลัพธ์จากการบันทึก (Result class) — ของตัวเองใน license_attach_page
// ไม่ใช้ LicenseContractResult จาก license_contract_page
// ============================================================================

/// ผลลัพธ์ที่ส่งกลับเมื่อบันทึกสำเร็จ
class LicenseAttachResult {
  ...
  factory LicenseAttachResult.fromJson(Map<String, dynamic> json) {
  ...
  @override
  String toString() =>
      'LicenseAttachResult(uuid: $uuid, message: $message, status: $statusCode)';
}
