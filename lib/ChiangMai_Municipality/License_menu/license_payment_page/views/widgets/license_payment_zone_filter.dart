// ============================================================================
// license_payment_zone_filter.dart
// ============================================================================
...
class LicensePaymentZoneFilter extends StatefulWidget {
  const LicensePaymentZoneFilter({super.key});
...
class _LicensePaymentZoneFilterState extends State<LicensePaymentZoneFilter> {
  ...
  Widget _toggleHeader(LicensePaymentViewModel vm) {
  ...
  Widget _zoneSection(LicensePaymentViewModel vm) {
  ...
  Widget _statusSection(LicensePaymentViewModel vm) {
    return _FilterField(
  ...
  Widget _sortSection(LicensePaymentViewModel vm) {
  ...
  void _showSortMenu(LicensePaymentViewModel vm) {
    final isDesc = vm.selectedSortDir == 'desc';
    showDialog(
      context: context,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ...LicensePaymentViewModel.sortOptions.map((k) => InkWell(
                        onTap: () {
                          vm.onSortChanged(k);
                          Navigator.of(ctx).pop();
                        },
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: AutoSizeText(
                                  LicensePaymentViewModel.sortLabels[k] ?? k,
...
extension on _LicensePaymentZoneFilterState {
  ...
  Widget _statusDropdown(LicensePaymentViewModel vm) {
    final items = <String>['ทั้งหมด', ...LicensePaymentViewModel.statusOptions];
