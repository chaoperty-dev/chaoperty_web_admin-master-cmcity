...
class LicensePaymentTable extends StatelessWidget {
  const LicensePaymentTable({super.key});
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          for (int i = 0; i < vm.requests.length; i++)
            _dataRow(context, vm, vm.requests[i] as PaymentTask, i),
        ],
      ),
    );
  }
          ...
          child: Column(
            ...
            children: [
              ...
              _CardRow(
                  ...
                  label: 'บริเวณ',
                  value: task.details.subzone),
              _CardRow(
                  icon: Icons.layers_outlined,
                  label: 'โซนพื้นที่',
                  value: task.details.zn),
              _CardRow(
                  icon: Icons.tag,
                  label: 'รหัสพื้นที่',
                  value: lnFallback,
