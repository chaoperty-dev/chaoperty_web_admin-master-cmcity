...
// - ใช้ context.select<LicensePaymentViewModel, _PHeaderData> 1-arg selector
...
class LicensePaymentHeader extends StatelessWidget {
  ...
  const LicensePaymentHeader({super.key, this.subtitle});

  @override
  Widget build(BuildContext context) {
    final selected = context.select<LicensePaymentViewModel, _PHeaderData>(
      (vm) => _PHeaderData(title: vm.title, total: vm.total),
    );
  ...
  Widget _buildWideLayout(_PHeaderData data, String? subtitle) {
    return Row(
  ...
  Widget _buildMediumLayout(_PHeaderData data, String? subtitle) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.center,
      children: [
        Container(
  ...
  Widget _buildCompactLayout(_PHeaderData data, String? subtitle) {
    return Column(
...
class _PHeaderData {
  final String title;
  final int total;
  const _PHeaderData({required this.title, required this.total});

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other is _PHeaderData && other.title == title && other.total == total;
  }
