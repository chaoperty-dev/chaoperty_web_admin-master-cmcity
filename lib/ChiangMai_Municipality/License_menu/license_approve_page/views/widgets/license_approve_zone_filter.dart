// ============================================================================
// license_approve_zone_filter.dart
// ============================================================================
...
class LicenseApproveZoneFilter extends StatefulWidget {
  const LicenseApproveZoneFilter({super.key});

  @override
  State<LicenseApproveZoneFilter> createState() =>
      _LicenseRequestZoneFilterState();
}

class _LicenseRequestZoneFilterState extends State<LicenseApproveZoneFilter> {
  ...
  Widget _toggleHeader(LicenseApproveViewModel vm) {
    final hasFilter =
  ...
  Widget _subZoneSection(LicenseApproveViewModel vm) {
    return _FilterField(
  ...
  Widget _zoneSection(LicenseApproveViewModel vm) {
  ...
  Widget _statusSection(LicenseApproveViewModel vm) {
    return _FilterField(
  ...
  Widget _sortSection(LicenseApproveViewModel vm) {
  ...
  void _showSortMenu(LicenseApproveViewModel vm) {
    final isDesc = vm.selectedSortDir == 'desc';
    showDialog(
      context: context,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ...LicenseApproveViewModel.sortOptions.map((k) => InkWell(
                        onTap: () {
                          vm.onSortChanged(k);
                          Navigator.of(ctx).pop();
                        },
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: AutoSizeText(
                                  LicenseApproveViewModel.sortLabels[k] ?? k,
...
extension on _LicenseRequestZoneFilterState {
  Widget _subZoneDropdown(LicenseApproveViewModel vm) {
  ...
  Widget _zoneDropdown(LicenseApproveViewModel vm) {
    final enabled = vm.selectedZoneSub != null && !vm.readOnly;
    // กัน assertion fail: ถ้า value ไม่ตรงกับ item ใดเลย ให้ส่ง null
  ...
  Widget _statusDropdown(LicenseApproveViewModel vm) {
    final items = <String>['ทั้งหมด', ...LicenseApproveViewModel.statusOptions];
    ...
    return _DropdownShell(
      ...
      child: DropdownButton2<String>(
        ...
        hint: AutoSizeText(
          vm.selectedStatus == null
              ? 'ทั้งหมด'
              : (LicenseApproveViewModel.statusLabels[vm.selectedStatus] ??
                  vm.selectedStatus!),
          style: LaText.body.copyWith(
