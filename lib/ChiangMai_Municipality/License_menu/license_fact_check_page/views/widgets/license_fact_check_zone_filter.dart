// ============================================================================
// license_fact_check_zone_filter.dart
// ============================================================================
...
class LicensefactcheckZoneFilter extends StatefulWidget {
  const LicensefactcheckZoneFilter({super.key});

  @override
  State<LicensefactcheckZoneFilter> createState() =>
      _LicenseRequestZoneFilterState();
}

class _LicenseRequestZoneFilterState extends State<LicensefactcheckZoneFilter> {
  ...
  Widget _toggleHeader(LicensefactcheckViewModel vm) {
  ...
  Widget _subZoneSection(LicensefactcheckViewModel vm) {
    return _FilterField(
  ...
  Widget _zoneSection(LicensefactcheckViewModel vm) {
  ...
  Widget _statusSection(LicensefactcheckViewModel vm) {
    return _FilterField(
  ...
  Widget _sortSection(LicensefactcheckViewModel vm) {
  ...
  void _showSortMenu(LicensefactcheckViewModel vm) {
    final isDesc = vm.selectedSortDir == 'desc';
    showDialog(
      context: context,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ...LicensefactcheckViewModel.sortOptions.map((k) => InkWell(
                        onTap: () {
                          vm.onSortChanged(k);
                          Navigator.of(ctx).pop();
                        },
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: AutoSizeText(
                                  LicensefactcheckViewModel.sortLabels[k] ?? k,
...
extension on _LicenseRequestZoneFilterState {
  Widget _subZoneDropdown(LicensefactcheckViewModel vm) {
  ...
  Widget _zoneDropdown(LicensefactcheckViewModel vm) {
    final enabled = vm.selectedZoneSub != null && !vm.readOnly;
    return _DropdownShell(
      enabled: enabled,
      child: DropdownButton2<String>(
  ...
  Widget _statusDropdown(LicensefactcheckViewModel vm) {
    final items = <String>['ทั้งหมด', ...LicensefactcheckViewModel.statusOptions];
    ...
    return _DropdownShell(
      ...
      child: DropdownButton2<String>(
        ...
        hint: AutoSizeText(
          vm.selectedStatus == null
              ? 'ทั้งหมด'
              : (LicensefactcheckViewModel.statusLabels[vm.selectedStatus] ??
                  vm.selectedStatus!),
          style: LaText.body.copyWith(
