      ...
      child: Builder(
        builder: (context) {
          return Column(
            ...
            children: [
              // ─── Segmented tabs (สไตล์เดียวกับ attach/payment/fact-check) ───
              const _VerifySegmentedTabs(),
              // ─── TabBarView: 2 แท็บ ───
              Expanded(
                child: TabBarView(
...
// =============================================================================
class _VerifySegmentedTabs extends StatelessWidget {
  const _VerifySegmentedTabs();
  ...
  Widget build(BuildContext context) {
    return const Row(
      children: [
        ...
        SizedBox(width: 6),
        Expanded(
          child: Text('ตรวจสอบเอกสารก่อนกด "อนุมัติ"', style: LaText.caption),
        ),
      ],
    );
  }
        ...
        children: [
          ...
          LayoutBuilder(builder: (context, c) {
            ...
            final left =
              ...
              const _OverviewHeading('ข้อมูลพื้นที่'),
              const SizedBox(height: 6),
              _OverviewInfo(
            ...
            final right =
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              const _OverviewHeading('ข้อมูลผู้ขอ'),
              const SizedBox(height: 6),
              _OverviewInfo(
