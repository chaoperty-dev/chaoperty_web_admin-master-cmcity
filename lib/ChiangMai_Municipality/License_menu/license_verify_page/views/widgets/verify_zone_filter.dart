...
class VerifyZoneFilter extends StatefulWidget {
  const VerifyZoneFilter({super.key});

  @override
  State<VerifyZoneFilter> createState() =>
...
class _LicenseRequestZoneFilterState extends State<VerifyZoneFilter> {
  ...
  Widget _subZoneSection(LicenseVerifyViewModel vm) {
    return _FilterField(
  ...
  Widget _zoneSection(LicenseVerifyViewModel vm) {
  ...
  Widget _sortSection(LicenseVerifyViewModel vm) {
  ...
  void _showSortMenu(LicenseVerifyViewModel vm) {
    final isDesc = vm.selectedSortDir == 'desc';
    showDialog(
      context: context,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ...LicenseVerifyViewModel.sortOptions.map((k) => InkWell(
                        onTap: () {
                          vm.onSortChanged(k);
                          Navigator.of(ctx).pop();
                        },
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: AutoSizeText(
                                  LicenseVerifyViewModel.sortLabels[k] ?? k,
...
extension on _LicenseRequestZoneFilterState {
  Widget _subZoneDropdown(LicenseVerifyViewModel vm) {
  ...
  Widget _zoneDropdown(LicenseVerifyViewModel vm) {
    final enabled = vm.selectedZoneSub != null && !vm.readOnly;
    return _DropdownShell(
      enabled: enabled,
      child: DropdownButton2<String>(
