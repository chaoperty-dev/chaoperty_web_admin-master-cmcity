...
///
/// คืน `LicenseverifyAttachment?` — null ถ้าไม่เจอ
LicenseverifyAttachment? findAttachmentByDocId(
...
bool isImageAttachment(LicenseverifyAttachment att) {
...
bool isPdfAttachment(LicenseverifyAttachment att) {
  final fileType = (att.fileType ?? '').toString().toLowerCase();
  final fileName = (att.fileName ?? att.filePath ?? '').toString().toLowerCase();
