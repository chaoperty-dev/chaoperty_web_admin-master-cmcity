// ============================================================================
// verify_signature_view_model.dart
// ============================================================================
...
import '../services/verify_signature_service.dart';

class VerifySignatureViewModel extends ChangeNotifier {
  VerifySignatureViewModel({
    required this.documentsProvider,
    VerifySignatureService? service,
  }) : _service = service ?? VerifySignatureService();

  /// Callback ให้ VerifyDocumentsViewModel ส่ง documents มาให้
  /// (ลายเซ็นใช้ document ที่ code = 'users_signature')
  final List<LicenseverifyDocument> Function() documentsProvider;

  final VerifySignatureService _service;

  bool _isUploading = false;
  String? _errorMessage;
  LicenseverifyDocument? _signatureDoc;

  bool get isUploading => _isUploading;
  String? get errorMessage => _errorMessage;

  /// ค้นหา document ที่เป็นลายเซ็น (code = 'users_signature')
  LicenseverifyDocument? get signatureDoc {
