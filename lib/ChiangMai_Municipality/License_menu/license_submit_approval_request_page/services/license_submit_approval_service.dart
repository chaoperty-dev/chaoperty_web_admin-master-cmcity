...
class LicenseSubmitApprovalService {
  LicenseSubmitApprovalService({LicenseRequestService? requestService})
  ...
  // ---------- 4. Zones (v2 — ใช้ AreaZonesApi helper, self-caching 1 นาที) ----------
  ...
  // ---------- 5. SubZones (v2 — ใช้ AreaZonesApi helper) ----------
