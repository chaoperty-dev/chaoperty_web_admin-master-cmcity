// ============================================================================
// submit_approval_detail_header.dart
// ============================================================================
// Header bar ของหน้า "ส่งคำร้องขออนุมัติ" (Step 1 / Step 2)
// - Gradient slate-900 → slate-800 + glow (เหมือน verify / contract)
...
class SubmitApprovalDetailHeader extends StatelessWidget {
  final String title;
  ...
  const SubmitApprovalDetailHeader({
    super.key,
    required this.title,
    this.subtitle,
    this.currentStep = 1,
