...
class _SubmitApprovalDetailStep2State extends State<SubmitApprovalDetailStep2> {
  @override
  void initState() {
    super.initState();
...
class _Content extends StatelessWidget {
  ...
  bool _isNewStepAwaiting() {
    ...
    final isPending = s.isEmpty ||
        ...
        s.contains('progress');
    final noActedBy =
        step.actedBy == null || (step.actedBy ?? '').trim().isEmpty;
  ...
  Widget _actionHint() {
    return Container(
      ...
      child: const Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(Icons.touch_app_rounded, size: 12, color: LaColors.primaryDark),
          SizedBox(width: 4),
          Text(
