...
class _LicenseRequestZoneFilterState extends State<LicenseRequestZoneFilter> {
  ...
  Widget _toggleHeader(LicenseRequestViewModel vm) {
  ...
  Widget _statusSection(LicenseRequestViewModel vm) {
    return _FilterField(
  ...
  Widget _sortSection(LicenseRequestViewModel vm) {
  ...
  void _showSortMenu(LicenseRequestViewModel vm) {
    final isDesc = vm.selectedSortDir == 'desc';
    showDialog(
      context: context,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ...LicenseRequestViewModel.sortOptions.map((k) => InkWell(
                        onTap: () {
                          vm.onSortChanged(k);
                          Navigator.of(ctx).pop();
                        },
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: AutoSizeText(
                                  LicenseRequestViewModel.sortLabels[k] ?? k,
...
extension on _LicenseRequestZoneFilterState {
  ...
  Widget _statusDropdown(LicenseRequestViewModel vm) {
    // รายการตัวเลือก: "ทั้งหมด" + status ทั้งหมด
    final items = <String>['ทั้งหมด', ...LicenseRequestViewModel.statusOptions];
    ...
    return _DropdownShell(
      ...
      child: DropdownButton2<String>(
        ...
        hint: AutoSizeText(
          vm.selectedStatus == null
              ? 'ทั้งหมด'
              : (LicenseRequestViewModel.statusLabels[vm.selectedStatus] ??
                  vm.selectedStatus!),
          style: LrText.body.copyWith(
