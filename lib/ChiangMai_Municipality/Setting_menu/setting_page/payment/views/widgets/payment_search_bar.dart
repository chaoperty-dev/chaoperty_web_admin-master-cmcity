...
class PaymentSearchBar extends StatefulWidget {
  const PaymentSearchBar({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: _focused ? PayColors.primary : PayColors.border,
          width: _focused ? 1.6 : 1,
        ),
        boxShadow: [
          if (_focused)
            BoxShadow(
              color: PayColors.primary.withOpacity(.12),
              blurRadius: 12,
        ...
        children: [
          AnimatedSwitcher(
            ...
            child: Icon(
              ...
              color: _focused ? PayColors.primary : PayColors.textMuted,
              size: 20,
            ),
          ),
          ...
          Expanded(
            child: TextField(
              ...
              onSubmitted: (v) {
                _debounce?.cancel();
                final vm2 = context.read<PaymentViewModel>();
                vm2.setSearch(v);
                vm2.executeSearch();
              },
              style: PayText.body,
              cursorColor: PayColors.primary,
              decoration: InputDecoration(
                isCollapsed: true,
                border: InputBorder.none,
                hintText: hasText
                    ? 'ค้นหา "${_controller.text}"'
                    : 'ค้นหา... (รหัส, ชื่อบัญชี, เลขบัญชี, ธนาคาร)',
                hintStyle: PayText.bodyMuted.copyWith(
    ...
    return Tooltip(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Icon(icon, size: 14, color: PayColors.textSecondary),
        ),
      ),
    );
  }
