...
// - ✅ เลือกทั้งหมด / ล้าง
//
// ✅ ใช้ Selector — rebuild เฉพาะตอน columns / selectedCount เปลี่ยน
...
class _PickerData {
  ...
  static bool _listEq(
      List<CustomerReportColumn> a, List<CustomerReportColumn> b) {
            ...
            child: ReorderableListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return _DropdownTile(
                  key: ValueKey('dd_cust_${col.field}'),
                  index: index,
                  column: col,
