// ============================================================================
// area_menu_detail_step2.dart
// ============================================================================
// Step 2 — บันทึกการรับชำระ (Empty page — skeleton)
// ============================================================================
...
class AreaMenuDetailStep2 extends StatelessWidget {
  const AreaMenuDetailStep2({super.key});

  @override
  Widget build(BuildContext context) {
    // Touch VM so it rebuilds when step changes
    context.watch<AreaMenuDetailViewModel>();
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: LaSpace.md),
                    Text(
                      'เนื้อหา Step 2 — บันทึกการรับชำระ',
                      style: LaText.h2,
                      textAlign: TextAlign.center,
                    ),
                    const SizedBox(height: LaSpace.sm),
                    Text(
                      'พื้นที่สำหรับแสดงแบบฟอร์มบันทึกการชำระเงิน, '
                      'วิธีการชำระ และหลักฐาน\n'
              ...
              const Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'เมื่อบันทึกเรียบร้อย กดปุ่ม "บันทึก" ด้านล่าง',
