// ============================================================================
// area_menu_detail_step1.dart
// ============================================================================
// Step 1 — ตรวจสอบรายการรับชำระ (Empty page — skeleton)
// ============================================================================
...
class AreaMenuDetailStep1 extends StatelessWidget {
  const AreaMenuDetailStep1({super.key});
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: LaSpace.md),
                    Text(
                      'เนื้อหา Step 1 — ตรวจสอบรายการรับชำระ',
                      style: LaText.h2,
                      textAlign: TextAlign.center,
                    ),
                    const SizedBox(height: LaSpace.sm),
                    Text(
                      'พื้นที่สำหรับแสดงรายละเอียดค่าธรรมเนียม, '
                      'ยอดที่ต้องชำระ และรายการที่เกี่ยวข้อง\n'
