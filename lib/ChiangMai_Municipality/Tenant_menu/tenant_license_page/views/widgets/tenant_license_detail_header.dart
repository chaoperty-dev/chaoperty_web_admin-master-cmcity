// ============================================================================
// tenant_license_detail_header.dart
// ============================================================================
// Header bar ของหน้า "ผู้เช่า" (Step 1 / Step 2)
...
class TenantLicenseDetailHeader extends StatelessWidget {
  final String title;
  ...
  const TenantLicenseDetailHeader({
    super.key,
    required this.title,
    this.subtitle,
    this.currentStep = 1,
