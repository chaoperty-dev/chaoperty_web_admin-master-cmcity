// ============================================================================
// tenant_license_theme.dart
// ============================================================================
// Shared design tokens (colors / typography / decoration) สำหรับหน้า
// "ผู้เช่า" — ใช้ซ้ำในทุก widget เพื่อให้ UI สม่ำเสมอ
// ============================================================================
...
class StatusPalette {
  ...
  static StatusPalette of(String? status) {
    ...
    // ── Tenant-specific statuses (exact / strong match first) ─────────────
    if (s == 'ปัจจุบัน' || s == 'current' || s == 'active') {
      return const StatusPalette(
