...
//         ? '${MyConstant().domain}/GC_bill_pay_BC_IncomeDisReport_All.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon&seruser=$user_ser_Trans_Mon'
//         : '${MyConstant().domain}/GC_bill_pay_BC_IncomeDisReport.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon&seruser=$user_ser_Trans_Mon';

//     String url_Daily = (zone_ser_Trans_Daily.toString() == '0')
//         ? '${MyConstant().domain}/GC_bill_pay_BC_DailyDisReport_All.php?isAdd=true&ren=$ren&date=$Value_TransDate_Daily&serzone=$zone_ser_Trans_Daily&seruser=$user_ser_Trans_Daily'
//         : '${MyConstant().domain}/GC_bill_pay_BC_DailyDisReport.php?isAdd=true&ren=$ren&date=$Value_TransDate_Daily&serzone=$zone_ser_Trans_Daily&seruser=$user_ser_Trans_Daily';
...
//     ///-------->
//     String url_Mon = (zone_ser_Trans_Mon.toString() == '0')
//         ? '${MyConstant().domain}/GC_bill_pay_BC_BankmovemenDisReport_All.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon&seruser=$user_ser_Trans_Mon'
//         : '${MyConstant().domain}/GC_bill_pay_BC_BankmovemenDisReport.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon&seruser=$user_ser_Trans_Mon';

//     String url_Daily = (zone_ser_Trans_Daily.toString() == '0')
//         ? '${MyConstant().domain}/GC_bill_pay_BC_Bank_DailyDisReport_All.php?isAdd=true&ren=$ren&date=$Value_TransDate_Daily&serzone=$zone_ser_Trans_Daily&seruser=$user_ser_Trans_Daily'
//         : '${MyConstant().domain}/GC_bill_pay_BC_Bank_DailyDisReport.php?isAdd=true&ren=$ren&date=$Value_TransDate_Daily&serzone=$zone_ser_Trans_Daily&seruser=$user_ser_Trans_Daily';
...
//         ? '${MyConstant().domain}/GC_bill_pay_historyselectBankAllDisReport.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$serzone_s&datex=$Value_TransDate_Daily&Typesearch=$Type_search&seruser=$seruser_s'
//         : '${MyConstant().domain}/GC_bill_pay_historyselectAllDisReport.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$serzone_s&datex=$Value_TransDate_Daily&Typesearch=$Type_search&seruser=$seruser_s';
//     try {
//       var response = await http.get(Uri.parse(url));
...
//                                 : () async {
//                                     Insert_log.Insert_logs('รายงาน',
//                                         'กดดูรายงานรายรับประจำวัน(เฉพาะรายการที่มีส่วนลด)');
//                                     TransIncome_Widget();
//                                   }),
//                         (Type_search != 'Daily')
//                             ? Padding(
