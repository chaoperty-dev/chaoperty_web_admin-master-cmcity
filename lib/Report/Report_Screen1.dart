...
class _ReportScreen1State extends State<ReportScreen1> {
  ...
  //   final TextEditingController Dropdown_Controller_zone1 =
  ...
  var Value_TransDate_Daily_S, Value_TransDate_Daily_L;
  ...
  List<dynamic> Type_Ref = [
    {"ser": "1", "st": "0", "type": "ref1", "pn": "Ref1"},
    {"ser": "2", "st": "0", "type": "ref2", "pn": "Ref2"},
    {"ser": "3", "st": "0", "type": "ref-chao", "pn": "Ref-chao"},
    {"ser": "4", "st": "0", "type": "inv", "pn": "อ้างถึง"},
  ];
  ///////////--------------------------------------------->
  String _verticalGroupValue_PassW = "EXCEL";
  String _ReportValue_type = "ปกติ";
  String _ReportValue_typeZone = "1โซน/พื้นที่";
  ...
  ///////////--------------------------------------------->
  String? renTal_user, renTal_name, zone_ser, zone_name, renTal_url;
...
////////--------------------------------------------->
  String? TypeIncome = 'ทั้งหมด', TypeIncome_ser = '1';
  List Type_Income = [
    'ทั้งหมด',
    'รายการที่มีส่วนลด',
    'ล็อคเสียบ',
    ...
    try {
      ...
      if (result != null) {
        for (var map in result) {
          ...
          var imgx = renTalModel.imglogo;
          setState(() {
            renTal_url = (imgx == null ||
                    imgx.toString() == '' ||
                    imgx.toString() == 'null')
                ? '${MyConstant().domain}/Awaitdownload/imagenot.png'
                : '${MyConstant().domain}/files/$foderx/logo/$imgx';
            foder = foderx;
            rtname = rtnamex;
            type = typexs;
            typex = typexx;
...
///////////--------------------------------------------->(รายงานรายรับ)
  Future<Null> red_Trans_billIncome() async {
    ...
    ///--------> AND c_financetrans.receipt_ser != '0'
    String url_Mon = (zone_ser_Trans_Mon.toString() == '0')
        ? '${MyConstant().domain}/GC_bill_pay_BC_IncomeReport_All.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon&seruser=$user_ser_Trans_Mon&ser_in=$TypeIncome_ser'
        : '${MyConstant().domain}/GC_bill_pay_BC_IncomeReport.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon&seruser=$user_ser_Trans_Mon&ser_in=$TypeIncome_ser';

    String url_Daily = (zone_ser_Trans_Daily.toString() == '0')
        ? '${MyConstant().domain}/GC_bill_pay_BC_DailyReport_All.php?isAdd=true&ren=$ren&s_date=$Value_TransDate_Daily_S&l_date=$Value_TransDate_Daily_L&serzone=$zone_ser_Trans_Daily&seruser=$user_ser_Trans_Daily&ser_in=$TypeIncome_ser'
        : '${MyConstant().domain}/GC_bill_pay_BC_DailyReport.php?isAdd=true&ren=$ren&s_date=$Value_TransDate_Daily_S&l_date=$Value_TransDate_Daily_L&serzone=$zone_ser_Trans_Daily&seruser=$user_ser_Trans_Daily&ser_in=$TypeIncome_ser';
...
///////////--------------------------------------------->(รายงานการเคลื่อนไหวธนาคาร)
  Future<Null> red_Trans_billMovemen() async {
    ...
    ///-------->
    String url_Mon = (zone_ser_Trans_Mon.toString() == '0')
        ? '${MyConstant().domain}/GC_bill_pay_BC_BankmovemenReport_All.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon&seruser=$user_ser_Trans_Mon&ser_in=$TypeIncome_ser'
        : '${MyConstant().domain}/GC_bill_pay_BC_BankmovemenReport.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon&seruser=$user_ser_Trans_Mon&ser_in=$TypeIncome_ser';

    String url_Daily = (zone_ser_Trans_Daily.toString() == '0')
        ? '${MyConstant().domain}/GC_bill_pay_BC_Bank_DailyReport_All.php?isAdd=true&ren=$ren&s_date=$Value_TransDate_Daily_S&l_date=$Value_TransDate_Daily_L&serzone=$zone_ser_Trans_Daily&seruser=$user_ser_Trans_Daily&ser_in=$TypeIncome_ser'
        : '${MyConstant().domain}/GC_bill_pay_BC_Bank_DailyReport.php?isAdd=true&ren=$ren&s_date=$Value_TransDate_Daily_S&l_date=$Value_TransDate_Daily_L&serzone=$zone_ser_Trans_Daily&seruser=$user_ser_Trans_Daily&ser_in=$TypeIncome_ser';
    // print('result $url_Daily');
...
///////////--------------------------------------------->()
  ...
  Future<Null> red_Trans_selectIncomeAll() async {
    ...
    String url = (Value_Report == 'รายงานการเคลื่อนไหวธนาคาร' ||
        ...
        ? '${MyConstant().domain}/GC_bill_pay_historyselectBankAllReport.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$serzone_s&s_date=$Value_TransDate_Daily_S&l_date=$Value_TransDate_Daily_L&Typesearch=$Type_search&seruser=$seruser_s&ser_in=$TypeIncome_ser'
        : '${MyConstant().domain}/GC_bill_pay_historyselectAllReport.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$serzone_s&s_date=$Value_TransDate_Daily_S&l_date=$Value_TransDate_Daily_L&Typesearch=$Type_search&seruser=$seruser_s&ser_in=$TypeIncome_ser';
    // print(
...
///////////////-------------------------------->
          ...
          Expanded(
            child: Card(
              child: SfDateRangePicker(
                ...
                allowViewNavigation: (type == 1) ? false : true,
                ...
                onSelectionChanged:
                    (type == 1) ? selectionChanged_month1 : selectionChanged,
  ...
  void selectionChanged_month1(DateRangePickerSelectionChangedArgs args) {
    ...
    if (args.value is DateTime) {
      ...
      //                                   YE_Trans_Mon == '')
      setState(() {
        Mon_Trans_Mon = DateFormat('MM').format(selectedDate);
  ...
  void selectionChanged(DateRangePickerSelectionChangedArgs args) {
    if (args.value is PickerDateRange) {
      ...
      Value_TransDate_Daily_S =
          DateFormat('yyyy-MM-dd').format(range.startDate!);

      Value_TransDate_Daily_L =
          DateFormat('yyyy-MM-dd').format(range.endDate ?? range.startDate!);
    } else if (args.value is DateTime) {
      _selectedDate = DateFormat('dd-MM-yyyy').format(args.value);
      Value_TransDate_Daily_S = DateFormat('yyyy-MM-dd').format(args.value);

      Value_TransDate_Daily_L = DateFormat('yyyy-MM-dd').format(args.value);
    }
                        ...
                        child: Container(
                          ...
                          child: DropdownButtonFormField2(
                            ...
                            onChanged: (value) async {
                              int selectedIndex = Type_Income.indexWhere(
                                  (item) => item == value);
                              setState(() {
                          ...
                          onTap: (Mon_Trans_Mon == null)
                              ...
                              : () async {
                                  if (Mon_Trans_Mon != null &&
                                    ...
                                    Dia_log();
                                    try {
                                      red_Trans_billIncome().then((result) {
                                        try {
                  ...
                  child: Row(
                    children: [
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          onTap: () async {
                            if (Value_TransDate_Daily_L != null &&
                                zone_ser_Trans_Daily != null) {
                              setState(() {
                                Type_search = 'Daily';
                              });
                              ...
                              try {
                                red_Trans_billIncome().then((result) {
                                  try {
                                    red_Trans_billMovemen().then((result) {
                                      // print('tenant_Pakan');
                                      // print('tenant_Pakan');
                                      setState(() {
                                        Await_Status_Report1 = 1;
                  ...
                  children: [
                    InkWell(
                        ...
                        onTap: (TransReBillModels.length == 0 ||
                            ...
                            : () async {
                                Insert_log.Insert_logs(
                                    'รายงาน', 'กดดูรายงานรายรับประจำวัน');
                                TransIncome_Widget();
                              }),
                    (Type_search != 'Daily')
                        ? Padding(
                        ...
                        onTap: (TransReBillBank.length == 0 ||
                            ...
                            : () async {
                                Insert_log.Insert_logs('รายงาน',
                                    'กดดูรายงานการเคลื่อนไหวธนาคารประจำวัน');
                                TransIncomeBank_Widget();
                              }),
                    (Type_search != 'Daily')
                        ? Padding(
                                                            ...
                                                            children: [
                                                              ...
                                                              Expanded(
                                                                ...
                                                                child: Text(
                                                                  ...
                                                                  //  '${nFormat.format(double.parse(TransReBillModels[index1].total_bill!) - double.parse(TransReBillModels[index1].total_dis!))}',
                                                                  //'${TransReBillModels[index1].total_bill}',
                                                                  textAlign:
                                                                      TextAlign
                                                                          .right,
                                                                  style:
                  ...
                  child: ListBody(
                    children: <Widget>[
                      ...
                      const Text(
                        ...
                        style: TextStyle(
                          color: ReportScreen_Color.Colors_Text2_,
                          // fontWeight: FontWeight.bold, Type_Ref
                          fontFamily: Font_.Fonts_T,
                        ),
                      ),
                      Container(
                      ...
                      Padding(
                        ...
                        child: const Text(
                          'โซน/พื้นที่ : (กรณีที่1 ใบเสร็จมีหลายโซน/พื้นที่)',
                          style: TextStyle(
                            fontSize: 15,
                            color: ReportScreen_Color.Colors_Text2_,
                            // fontWeight: FontWeight.bold, Type_Ref
                      ...
                      Container(
                        ...
                        child: RadioGroup<String>.builder(
                          direction: Axis.horizontal,
                          groupValue: _ReportValue_typeZone,
                          horizontalAlignment: MainAxisAlignment.spaceAround,
                          onChanged: (value) {
                            // setState(() {
                            //   FormNameFile_text.clear();
                      ...
                      if (_ReportValue_type.toString() == 'ภาษีขาย')
                        Padding(
                          ...
                          child: Container(
                            ...
                            padding: const EdgeInsets.all(8.0), //Type_Ref
                            child: DropdownButtonHideUnderline(
                              child: DropdownButton2<String>(
                                isExpanded: true,
                                hint: Text(
                                  'เลือก Ref-อ้างอิงที่จะแสดง',
                                  style: const TextStyle(
                                    fontSize: 14,
                                    color: ReportScreen_Color.Colors_Text1_,
                                    // fontWeight: FontWeight.bold,
                                ...
                                items: [
                                  for (int index = 0;
                                      index < Type_Ref.length;
                                      index++)
                                    DropdownMenuItem(
                                      value: Type_Ref[index]["ser"],
...
////////////------------------------------------------>
  void InkWell_onTap(context) async {
    Dia_log2();
    await red_Trans_selectIncomeAll().then((_) {
      Navigator.of(context).pop();
    });
    setState(() {
      NameFile_ = '';
        ...
        if (Value_Report == 'รายงานรายรับ') {
          ...
          (_ReportValue_type == "ปกติ")
              ? Excgen_IncomeReport.exportExcel_IncomeReport(
                  ...
                  YE_Trans_Mon,
                  userModels,
                  _ReportValue_typeZone)
              : (_ReportValue_type == "ย่อ")
                  ...
                  : Excgen_TaxReport.exportExcel_TaxReport(
                      ...
                      Mon_Trans_Mon == null
                          ? Mon_Trans_Mon
                          : monthsInThai[
                              int.parse(Mon_Trans_Mon.toString() ?? '0') - 1],
                      YE_Trans_Mon ?? 0,
                      Value_TransDate_Daily,
                      userModels,
                      renTal_url,
                      Type_Ref.where((element) => element["st"]! == '1')
                          .toList(),
                      _ReportValue_typeZone);
          ...
          (_ReportValue_type == "ปกติ")
              ...
              : (_ReportValue_type == "ย่อ")
                  ...
                  : Excgen_TaxReport.exportExcel_TaxReport(
                      '$TypeIncome_ser',
                      context,
                      'รายงานภาษีขาย-เฉพาะการเคลื่อนไหวธนาคาร',
                      _verticalGroupValue_NameFile,
                      Value_Report,
                      TransReBillModels,
                      TransHisBillBank,
