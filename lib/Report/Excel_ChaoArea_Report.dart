...
// Protecting the Worksheet by using a Password
    ...
    sheet.getRangeByName('J4').setText('ประเภทร้านค้า');
    sheet.getRangeByName('K4').setText('รหัสสมาชิก');
    sheet.getRangeByName('L4').setText('ผู้เช่า');
    ...
    for (int index = 0; index < areaModels.length; index++) {
      ...
      sheet.getRangeByName('F${index + 5}').setText(
            areaModels[index].cid2 == null ? '' : '${areaModels[index].cid2}',
          );
      ...
      sheet.getRangeByName('J${index + 5}').setText(
            areaModels[index].stype == null ? '' : '${areaModels[index].stype}',
          );
      sheet.getRangeByName('K${index + 5}').setText(
            areaModels[index].custno == null
                ? ''
                : '${areaModels[index].custno}',
          );
