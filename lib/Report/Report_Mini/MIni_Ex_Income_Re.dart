...
// Protecting the Worksheet by using a Password
    ...
    sheet.getRangeByName('W4').setText('รหัสแอดมินผู้ทำรายการ');
    ...
    for (var index1 = 0; index1 < TransReBillModels.length; index1++) {
      ...
      sheet.getRangeByName('L${indextotol + 5 - 1}').setNumber(
            (TransReBillModels[index1].total_bill == null)
                ? 0 + double.parse(TransReBillModels[index1].total_dis!)
      ...
      sheet
          ...
          .setNumber(double.parse(TransReBillModels[index1].total_bill!)
              // (TransReBillModels[index1].total_dis == null)
              //     ? double.parse(TransReBillModels[index1].total_bill!)
              //     : double.parse(TransReBillModels[index1].total_bill!) -
              //         double.parse(TransReBillModels[index1].total_dis!),
    ...
    for (var index = 0; index < userModels.length; index++) {
      if (userModels[index].ser.toString() == '0') {
        ...
        sheet2.getRangeByName('F${index + 2}').setFormula(
            '=Sheet1!K${indextotol + 5 + 2}-SUM(F${index + 3}:F${userModels.length + 1})');
        sheet2.getRangeByName('G${index + 2}').setFormula(
            '=Sheet1!L${indextotol + 5 + 2}-SUM(G${index + 3}:G${userModels.length + 1})');
        sheet2.getRangeByName('H${index + 2}').setFormula(
            '=Sheet1!M${indextotol + 5 + 2}-SUM(H${index + 3}:H${userModels.length + 1})');

        sheet2.getRangeByName('I${index + 2}').setFormula(
            '=Sheet1!N${indextotol + 5 + 2}-SUM(I${index + 3}:I${userModels.length + 1})');
      } else {
        sheet2
        ...
        sheet2.getRangeByName('E${index + 2}').setFormula(
            '=COUNTIF(Sheet1!W5:Sheet1!W${indextotol + 5 - 1},A${index + 2})');

        sheet2.getRangeByName('F${index + 2}').setFormula(
            '=SUMIF(Sheet1!W5:Sheet1!W${indextotol + 5 - 1}, "${userModels[index].ser}",Sheet1!K5:Sheet1!K${indextotol + 5 - 1})');

        sheet2.getRangeByName('G${index + 2}').setFormula(
            '=SUMIF(Sheet1!W5:Sheet1!W${indextotol + 5 - 1}, "${userModels[index].ser}",Sheet1!L5:Sheet1!L${indextotol + 5 - 1})');

        sheet2.getRangeByName('H${index + 2}').setFormula(
            '=SUMIF(Sheet1!W5:Sheet1!W${indextotol + 5 - 1}, "${userModels[index].ser}",Sheet1!M5:Sheet1!M${indextotol + 5 - 1})');

        sheet2.getRangeByName('I${index + 2}').setFormula(
            '=SUMIF(Sheet1!W5:Sheet1!W${indextotol + 5 - 1}, "${userModels[index].ser}",Sheet1!N5:Sheet1!N${indextotol + 5 - 1})');
      }
