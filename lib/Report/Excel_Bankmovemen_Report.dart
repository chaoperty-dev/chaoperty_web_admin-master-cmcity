...
// Protecting the Worksheet by using a Password
    ...
    sheet.getRangeByName('AB4').columnWidth = 18;
    sheet.getRangeByName('AC4').columnWidth = 18;
    sheet.getRangeByName('AD4').columnWidth = 18;
      ...
      if (matchingItems.isNotEmpty) {
        ...
        matchingItems.forEach((item) {
          ...
          sheet
              ...
              .setText('${TransHisBillBank[index2].ref2}');
          sheet
              .getRangeByName('AC${indextotol + 5 - 1}')
              .setText('${TransHisBillBank[index2].ref4}');
          sheet
              .getRangeByName('AD${indextotol + 5 - 1}')
              .setText('${TransHisBillBank[index2].ref1}');
        });
      }
