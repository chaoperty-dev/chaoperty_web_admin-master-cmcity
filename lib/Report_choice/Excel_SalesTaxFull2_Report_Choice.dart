...
////////////-------------------------------------------------------->
    ...
    sheet.getRangeByName('A5').setText('ทั้งหมด :${salesTax_full2.length}');
...
// Protecting the Worksheet by using a Password
    ...
    sheet.getRangeByName('L6').columnWidth = 30;
    sheet.getRangeByName('M6').columnWidth = 30;
    sheet.getRangeByName('N6').columnWidth = 30;
    ...
    sheet.getRangeByName('Z6').columnWidth = 25;
    sheet.getRangeByName('AA6').columnWidth = 25;
    sheet.getRangeByName('AB6').columnWidth = 25;
    sheet.getRangeByName('AC6').columnWidth = 25;
    sheet.getRangeByName('AD6').columnWidth = 25;
    sheet.getRangeByName('AE6').columnWidth = 25;
    ...
    sheet.getRangeByName('I6').setText('ค่าเช่าพื้นที่ดิน(ก่อนVAT-ส่วนลด)');
    sheet.getRangeByName('J6').setText('ค่าเช่าพื้นที่ดิน(WHT)');
    sheet.getRangeByName('K6').setText('ค่าเช่าพื้นที่ดิน(VAT)');
    sheet.getRangeByName('L6').setText('ค่าเช่า(ก่อนVAT-ส่วนลด)');
    sheet.getRangeByName('M6').setText('ค่าเช่า(WHT)');
    sheet.getRangeByName('N6').setText('ค่าเช่า(VAT)');
    sheet.getRangeByName('O6').setText('ค่าบริการพื้นที่(ก่อนVAT-ส่วนลด)');
    sheet.getRangeByName('P6').setText('ค่าบริการพื้นที่(WHT)');
    sheet.getRangeByName('Q6').setText('ค่าบริการพื้นที่(VAT)');
    sheet.getRangeByName('R6').setText('ค่าน้ำ(+VAT)');
    sheet.getRangeByName('S6').setText('ค่าไฟฟ้า(+VAT)');
    sheet.getRangeByName('T6').setText('ค่าปรับ(+VAT)');
    sheet.getRangeByName('U6').setText('อื่นๆ(+VAT)');
    sheet.getRangeByName('V6').setText('ส่วนลดทั้งใบเสร็จ');
    sheet.getRangeByName('W6').setText('หักณที่จ่ายทั้งใบเสร็จ');
    sheet.getRangeByName('X6').setText('จำนวนเงินรวม(+ค่าปรับ+อื่นๆ)');

    sheet.getRangeByName('Y6').setText('ref1');
    sheet.getRangeByName('Z6').setText('ref2');
    sheet.getRangeByName('AA6').setText('ref-chao');
    sheet.getRangeByName('AB6').setText('อ้างถึง');
    sheet.getRangeByName('AC6').setText('ช่องทางชำระ');
    sheet.getRangeByName('AD6').setText('เลขที่สัญญา');
    sheet.getRangeByName('AE6').setText('วันที่เริ่มสัญญา');
    ...
    for (int index = 0; index < salesTax_full2.length; index++) {
      ...
      try {
        ...
        sheet.getRangeByName('B${index + 7}').setValue(
              (salesTax_full2[index].pdate == null ||
                      salesTax_full2[index].pdate.toString() == '')
                  ? null
                  : DateTime.parse('${salesTax_full2[index].pdate}'),
            );
      } catch (e) {
        sheet.getRangeByName('B${index + 7}').setText((salesTax_full2[index]
                        .pdate ==
                    null ||
                salesTax_full2[index].pdate.toString() == '')
            ? ''
      ...
      sheet.getRangeByName('E${index + 7}').setText(
            (salesTax_full2[index].zn!.split('_')[0].length <= 4)
      ...
      sheet
          ...
          .setText('${salesTax_full2[index].ln}');
      ...
      sheet.getRangeByName('I${index + 7}').setNumber(
          (salesTax_full2[index].land_pvat == null)
              ? 0.00
              : double.parse('${salesTax_full2[index].land_pvat}'));
      sheet.getRangeByName('J${index + 7}').setNumber(
          (salesTax_full2[index].land_wht == null)
              ? 0.00
              : double.parse('${salesTax_full2[index].land_wht}'));

      sheet.getRangeByName('K${index + 7}').setNumber(
          (salesTax_full2[index].land_vat == null)
              ? 0.00
              : double.parse('${salesTax_full2[index].land_vat}'));
      ...
      sheet.getRangeByName('M${index + 7}').setNumber(
          (salesTax_full2[index].rent_wht == null)
              ? 0.00
              : double.parse('${salesTax_full2[index].rent_wht}'));
      ...
      sheet.getRangeByName('P${index + 7}').setNumber(
          (salesTax_full2[index].service_wht == null)
              ? 0.00
              : double.parse('${salesTax_full2[index].service_wht}'));
      ...
      sheet.getRangeByName('R${index + 7}').setNumber(
          (salesTax_full2[index].water == null)
              ? 0.00
              : double.parse('${salesTax_full2[index].water}'));

      sheet.getRangeByName('S${index + 7}').setNumber(
          (salesTax_full2[index].electricity == null)
              ? 0.00
              : double.parse('${salesTax_full2[index].electricity}'));

      sheet.getRangeByName('T${index + 7}').setNumber(
          (salesTax_full2[index].fine == null)
              ? 0.00
              : double.parse('${salesTax_full2[index].fine}'));
      sheet.getRangeByName('U${index + 7}').setNumber(
          (salesTax_full2[index].equip_total == null)
              ? 0.00
              : double.parse('${salesTax_full2[index].equip_total}'));
      sheet.getRangeByName('V${index + 7}').setNumber(
          (salesTax_full2[index].total_dis == null)
              ? 0.00
              : double.parse('${salesTax_full2[index].total_dis}'));
      sheet.getRangeByName('W${index + 7}').setNumber(
          (salesTax_full2[index].total_wht == null)
              ? 0.00
              : double.parse('${salesTax_full2[index].total_wht}'));
      sheet.getRangeByName('X${index + 7}').setNumber((double.tryParse(
                  '${salesTax_full2[index].rent_total}') ??
              0.00) +
          (double.tryParse('${salesTax_full2[index].service_total}') ?? 0.00) +
          (double.tryParse('${salesTax_full2[index].land_total}') ?? 0.00) +
          (double.tryParse('${salesTax_full2[index].fine}') ?? 0.00) +
          (double.tryParse('${salesTax_full2[index].equip_total}') ?? 0.00) +
          (double.tryParse('${salesTax_full2[index].electricity}') ?? 0.00) +
          (double.tryParse('${salesTax_full2[index].water}') ?? 0.00));

      // sheet.getRangeByName('X${index + 7}').setFormula(
      //     '=SUM(I${index + 7}:U${index + 7})'
      //     // '=SUM(H${index + 7},I${index + 7},J${index + 7},K${index + 7},L${index + 7},M${index + 7})'
      //     );

      sheet
          .getRangeByName('Y${index + 7}')
          .setText('${salesTax_full2[index].ref2}');
      sheet
          .getRangeByName('Z${index + 7}')
          .setText('${salesTax_full2[index].ref4}');
      sheet
          .getRangeByName('AA${index + 7}')
          .setText('${salesTax_full2[index].ref1}');
      sheet
          .getRangeByName('AB${index + 7}')
          .setText('${salesTax_full2[index].inv}');
      sheet
          .getRangeByName('AC${index + 7}')
          .setText('${salesTax_full2[index].type}');
      sheet
          .getRangeByName('AD${index + 7}')
          .setText('${salesTax_full2[index].cid}');

      try {
        sheet.getRangeByName('AE${index + 7}').cellStyle.numberFormat =
            'dd-MM-yyyy';
        sheet.getRangeByName('AE${index + 7}').setValue(
              (salesTax_full2[index].sdate == null ||
                      salesTax_full2[index].sdate.toString() == '')
                  ? null
                  : DateTime.parse('${salesTax_full2[index].sdate}'),
            );
      } catch (e) {
        sheet.getRangeByName('AE${index + 7}').setText((salesTax_full2[index]
                    .sdate ==
                null)
            ? ''
            : '${DateFormat('dd-MM').format(DateTime.parse('${salesTax_full2[index].sdate} 00:00:00'))}-${DateTime.parse('${salesTax_full2[index].sdate} 00:00:00').year + 0}');
      }
...
/////////---------------------------->
    ...
    sheet
        ...
        .setFormula('=SUM(W7:W${indextotol + 7 - 1})');
    sheet
        .getRangeByName('X${indextotol + 7 + 0}')
        .setFormula('=SUM(X7:X${indextotol + 7 - 1})');
...
/////////---------------------------->
    ...
    String path = await FileSaver.instance.saveFile(
        (Value_Chang_Zone_SalesTax_Full2 == null)
            ? 'รายงานภาษีขาย-2 ประจำวันที่1ถึง24 ${Mon_SalesTax_Full_Mon2} ${YE_SalesTax_Full_Mon2} (กรุณาเลือกโซน)'
            : 'รายงานภาษีขาย-2 ประจำวันที่1ถึง24 ${Mon_SalesTax_Full_Mon2} ${YE_SalesTax_Full_Mon2} (โซน : $Value_Chang_Zone_SalesTax_Full2)',
        data,
        "xlsx",
        mimeType: type);
    log(path);
