class TransReChackBillModel {
  ...
  TransReChackBillModel.fromJson(Map<String, dynamic> json) {
    ser = json['ser'];
    datex = json['datex'];
    timex = json['timex'];
    user = json['user'];
    ...
    status = json['status'];
    ref_id_chack = json['ref_id_chack'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['ref_id_chack'] = this.ref_id_chack;
