...
class PdfgeCancel_Rental_Choice {
  static void exportPDF_Cancel_Rental_Choice(
    ...
    //////--------------------------------------------->
    final thaiDate2 = DateTime.parse(w1_date.toString());
    final formatter2 = DateFormat('d MMMM', 'th_TH');
    final formattedDate2 = formatter.format(thaiDate2);
    //////--------------->พ.ศ.
    DateTime dateTime2 = DateTime.parse(w1_date.toString());
    int newYear2 = dateTime.year + 543;
    //////--------------------------------------------->
...
////////////////------------------------------->
    ...
    for (var model in transKonModels) {
      try {
        // แปลงค่าจาก String เป็น double แล้วบวกเข้าผลรวม
        sumTotal += double.parse(model.total ?? '0');
      } catch (e) {
        print('Error parsing total: ${model.total}');
      }
    }

    String formattedTotal = nFormat.format(sumTotal);
////////////////------------------------------->
    pdf.addPage(
      pw.MultiPage(
                        ...
                        child: pw.Column(
                          ...
                          children: [
                            if (TitleType_Default_Receipt_Name != null &&
                              ...
                              pw.Padding(
                                padding:
                                    const pw.EdgeInsets.fromLTRB(0, 0, 10, 0),
                                child: pw.Container(
                                  width: 80,
                                  decoration: pw.BoxDecoration(
                            ...
                            pw.Text(
                              'วันที่กำหนดยกเลิกล่วงหน้า : $formattedDate ${newYear}',
                              textAlign: pw.TextAlign.right,
                              maxLines: 1,
                              style: pw.TextStyle(
                                fontSize: font_Size,
                            ...
                            pw.Text(
                              (w1_date.toString() == '0000-00-00' ||
                                      w1_date == null ||
                                      w1_date.toString() == '')
                                  ? 'วันที่ทำรายการยกเลิก : - '
                                  : 'วันที่ทำรายการยกเลิก : $formattedDate2 ${newYear2}',
                              textAlign: pw.TextAlign.right,
                              maxLines: 1,
                              style: pw.TextStyle(
                                fontSize: font_Size,
                                      ...
                                      pw.Container(
                                        ...
                                        child: pw.Row(
                                          ...
                                          children: [
                                            ...
                                            pw.Text(
                                              (index == 0)
                                                  ? 'ผู้เช่า/ผู้รับบริการ' //ผู้จัดการ'
                                                  : (index == 1)
                                                      ? 'เจ้าหน้าที่/พนักงาน' //'รองผู้จัดการ'
                                                      : (index == 2)
                                                          ? 'พนักงาน'
                                                          : 'อื่นๆ',
                                              textAlign: pw.TextAlign.left,
