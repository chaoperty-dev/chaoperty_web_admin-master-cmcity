                            ...
                            child: pw.Text(
                              (quotxSelectModels.length == 0 ||
                                      quotxSelectModels
                                          ...
                                          0)
                                  ? '0.00'
                                  : '${nFormat.format(quotxSelectModels.where((e) => e.expser.toString() == '16' && e.cfid.toString() == '0').map((e) => e.total_prev != null ? double.parse(e.total_prev.toString()) : 0.00).fold(0.00, (a, b) => a + b))}',
                              // +
