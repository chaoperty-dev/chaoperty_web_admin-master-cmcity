            ...
            pw.Container(
                ...
                child: pw.Column(
                    ...
                    children: [
                            ...
                            child: pw.Text(
                              (quotxSelectModels.length == 0 ||
                                      quotxSelectModels
                                          ...
                                          0)
                                  ? '0.00'
                                  : '${nFormat.format(quotxSelectModels.where((e) => e.expser.toString() == '1' && e.cfid.toString() == '0').map((e) => e.total != null ? double.parse(e.total.toString()) : 0.00).fold(0.00, (a, b) => a + b))}',
                              // +
                      ...
                      pw.Text(
                        ' ' * 12 +
                            'บัดนี้ ใกล้ครบกำหนดระยะเวลาตามสัญญาเช่าดังกล่าวแล้ว คู่สัญญาทั้งสองฝ่ายพิจารณาแล้วตกลงต่ออายุสัญญาเช่าออกไป',
                        textAlign: pw.TextAlign.left,
                        style: pw.TextStyle(
                          fontSize: font_Size,
                          font: ttf,
                          ...
                          child: pw.Container(
                            ...
                            child: pw.Text(
                              (quotxSelectModels
                                      ...
                                      .isEmpty)
                                  ? '0.00'
                                  : '${nFormat.format(double.parse(quotxSelectModels.firstWhere((e) => e.expser.toString() == '1' && e.cfid.toString() == '0').pvat ?? '0.00'))} บาท',
                              // (quotxSelectModels.length == 0 ||
                              //         quotxSelectModels
                              //                 .where((e) =>
                              //                     e.expser.toString() == '1' &&
                              ...
                              //             0)
                              //     ? '0.00'
                              //     : '${nFormat.format(quotxSelectModels.where((e) => e.expser.toString() == '1' && e.cfid.toString() == '0').map((e) => e.pvat != null ? double.parse(e.pvat.toString()) : 0.00).fold(0.00, (a, b) => a + b))} บาท ',
                              // " -  บาท ( - )",
                              textAlign: pw.TextAlign.center,
                              style: pw.TextStyle(
                                color: Colors_pd,
                      ...
                      pw.Row(children: [
                          ...
                          child: pw.Container(
                            ...
                            child: pw.Text(
                              (quotxSelectModels
                                      ...
                                      .isEmpty)
                                  ? '0.00'
                                  : '${nFormat.format(double.parse(quotxSelectModels.firstWhere((e) => e.expser.toString() == '1' && e.cfid.toString() == '0').vat ?? '0.00'))} บาท',
                              // (quotxSelectModels
                              //             .where((e) =>
                              //                 e.expser.toString() == '1' &&
                              //                 e.cfid.toString() == '0')
                              ...
                              //         0)
                              //     ? '0.00'
                              //     : '${nFormat.format(quotxSelectModels.where((e) => e.expser.toString() == '1' && e.cfid.toString() == '0').map((e) => e.vat != null ? double.parse(e.vat.toString()) : 0.00).fold(0.00, (a, b) => a + b))} บาท ',
                              // " -  บาท ( - )",
                              textAlign: pw.TextAlign.center,
                              style: pw.TextStyle(
                                color: Colors_pd,
                        ...
                        pw.Text(
                          (quotxSelectModels
                              ...
                              ? 'หักภาษี ณ ที่จ่าย '
                              : 'หักภาษี ณ ที่จ่าย ' +
                                  '( ${quotxSelectModels.firstWhere((e) => e.expser.toString() == '1' && e.cfid.toString() == '0').nwht != null ? double.parse(quotxSelectModels.firstWhere((e) => e.expser.toString() == '1' && e.cfid.toString() == '0').nwht.toString()) : 0.00} ) % ',
                          // (quotxSelectModels
                          //             .where((e) =>
                          //                 e.expser.toString() == '1' &&
                          //                 e.cfid.toString() == '0')
                          ...
                          //                     e.cfid.toString() == '0')
                          //                 .map((e) => e.nwht != null
                          //                     ? double.parse(e.nwht.toString())
                          //                     : 0.00)
                          //                 .fold(0.00, (a, b) => a + b) ==
                          //             0)
                          //         ? 'หักภาษี ณ ที่จ่าย '
                          //         : 'หักภาษี ณ ที่จ่าย ' +
                          //             '( ${quotxSelectModels.where((e) => e.expser.toString() == '1' && e.cfid.toString() == '0').map((e) => e.nwht != null ? double.parse(e.nwht.toString()) : 0.00).fold(0.00, (a, b) => a + b)} ) % ',
                          textAlign: pw.TextAlign.left,
                          ...
                          child: pw.Container(
                            ...
                            child: pw.Text(
                              (quotxSelectModels
                                      ...
                                      .isEmpty)
                                  ? '0.00'
                                  : '${nFormat.format(double.parse(quotxSelectModels.firstWhere((e) => e.expser.toString() == '1' && e.cfid.toString() == '0').wht ?? '0.00'))} บาท',
                              // (quotxSelectModels
                              //             .where((e) =>
                              //                 e.expser.toString() == '1' &&
                              //                 e.cfid.toString() == '0')
                              ...
                              //         0)
                              //     ? '0.00'
                              //     : '${nFormat.format(quotxSelectModels.where((e) => e.expser.toString() == '1' && e.cfid.toString() == '0').map((e) => e.wht != null ? double.parse(e.wht.toString()) : 0.00).fold(0.00, (a, b) => a + b))} บาท ',
                              // " -  บาท ( - )",
                              textAlign: pw.TextAlign.center,
                              style: pw.TextStyle(
                                color: Colors_pd,
                          ...
                          child: pw.Container(
                            ...
                            child: pw.Text(
                              (quotxSelectModels
                                  ...
                                  : '${nFormat.format(double.parse(quotxSelectModels.firstWhere((e) => e.expser.toString() == '1' && e.cfid.toString() == '0').total ?? '0.00'))} บาท ' +
                                      '(~${convertToThaiBaht(double.parse(quotxSelectModels.firstWhere((e) => e.expser.toString() == '1' && e.cfid.toString() == '0').total ?? '0.00'))}~)',
                              // (quotxSelectModels
                              //             .where((e) =>
                              //                 e.expser.toString() == '1' &&
                              //                 e.cfid.toString() == '0')
                              ...
                              //         0)
                              //     ? '0.00 บาท (~${convertToThaiBaht(0.00)}~)'
                              //     : '${nFormat.format(quotxSelectModels.where((e) => e.expser.toString() == '1' && e.cfid.toString() == '0').map((e) => e.total != null ? double.parse(e.total.toString()) : 0.00).fold(0.00, (a, b) => a + b))} บาท ' +
                              //         '(~${convertToThaiBaht(quotxSelectModels.where((e) => e.expser.toString() == '1' && e.cfid.toString() == '0').map((e) => e.total != null ? double.parse(e.total.toString()) : 0.00).fold(0.00, (a, b) => a + b))}~)',
                              // " -  บาท ( - )",
                              textAlign: pw.TextAlign.center,
                              style: pw.TextStyle(
                                color: Colors_pd,
                              ...
                              (Get_Value_cid.toString() ==
                                  ...
                                  : (Form_PakanAll_Total_first == null ||
                                      ...
                                      : '${nFormat.format(double.parse('${Form_PakanAll_Total_first}'))} บาท ' +
                                          '(~${convertToThaiBaht(double.parse('${Form_PakanAll_Total_first}'))}~)',
                              textAlign: pw.TextAlign.center,
                              style: pw.TextStyle(
                                color: Colors_pd,
                                fontSize: font_Size,
                            ...
                            child: pw.Text(
                              (quotxSelectModels.length == 0 ||
                                  ...
                                  ? (Get_Value_cid.toString() ==
                                          Form_renew_cid.toString())
                                      ? '0.00 บาท(~${convertToThaiBaht(0.00)}~)'
                                      : '${(Form_PakanAll_Total_first == null || Form_PakanAll_Total_first.toString() == '') ? nFormat.format(0.00) : nFormat.format(double.parse('${Form_PakanAll_Total_first}'))} บาท ' +
                                          '(~${convertToThaiBaht(double.parse((Form_PakanAll_Total_first == null || Form_PakanAll_Total_first.toString() == '') ? '0' : '${Form_PakanAll_Total_first}'))}~)'
                                  : '${nFormat.format(double.parse('${quotxSelectModels.where((e) => e.expser.toString() == '2').map((e) => e.total != null ? double.parse(e.total.toString()) : 0.00).fold(0.00, (a, b) => a + b)}') + double.parse((Form_PakanAll_Total_first == null || Form_PakanAll_Total_first.toString() == '') ? '0' : '${Form_PakanAll_Total_first}'))} บาท ' +
                                      '(~${convertToThaiBaht(double.parse('${quotxSelectModels.where((e) => e.expser.toString() == '2').map((e) => e.total != null ? double.parse(e.total.toString()) : 0.00).fold(0.00, (a, b) => a + b)}') + double.parse((Form_PakanAll_Total_first == null || Form_PakanAll_Total_first.toString() == '') ? '0' : '${Form_PakanAll_Total_first}'))}~)',
                              // (quotxSelectModels.length == 0)
                              //     ? (Get_Value_cid.toString() ==
                              //             Form_renew_cid.toString())
                            ...
                            child: pw.Text(
                              (quotxSelectModels.length == 0 ||
                                      quotxSelectModels
                                          ...
                                          0)
                                  ? '-'
                                  : (DatexChoice_Sub2_1text == null)
                                      ? '-'
                                      : '${DateFormat('dd MMM', 'th').format(DateTime.parse("${DateFormat("dd-MM-yyyy HH:mm:ss").parse('$DatexChoice_Sub2_1text 00:00:00')}"))} ${DateTime.parse("${DateFormat("dd-MM-yyyy HH:mm:ss").parse('$DatexChoice_Sub2_1text 00:00:00')}").year + 543}',
                            ...
                            child: pw.Text(
                              (quotxSelectModels.length == 0 ||
                                      quotxSelectModels
                                          ...
                                          0)
                                  ? '-'
                                  : (DatexChoice_Sub2_2text == null)
                                      ? '-'
                                      : '${DateFormat('dd MMM', 'th').format(DateTime.parse("${DateFormat("dd-MM-yyyy HH:mm:ss").parse('$DatexChoice_Sub2_2text 00:00:00')}"))} ${DateTime.parse("${DateFormat("dd-MM-yyyy HH:mm:ss").parse('$DatexChoice_Sub2_2text 00:00:00')}").year + 543}',
                              ...
                              //         0)
                              //     ? '-'
                              //     : '${quotxSelectModels.where((model) => model.expser.toString() == '22').map((model) => model.pdate).join(', ')}',
                              textAlign: pw.TextAlign.center,
                              style: pw.TextStyle(
                                color: Colors_pd,
                                fontSize: font_Size,
