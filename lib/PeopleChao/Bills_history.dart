                              ...
                              Container(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder:
                                    ...
                                    final row = _InvoiceHistoryModels[index];
                                    final expName = row.dtype == 'KU'
                                        ? '${row.expname} ${DateFormat.MMM('th_TH').format(DateTime.parse('${row.date} 00:00:00'))} ${DateTime.parse('${row.date} 00:00:00').year + 543}'
                                        : '${row.expname}';
                                    return Container(
                                                      ...
                                                      children: [
                                                        ...
                                                        Expanded(
                                                          ...
                                                          child: AutoSizeText(
                                                            minFontSize: 12,
                                                            maxFontSize: 14,
                                                            '${nFormat.format(_InvoiceHistoryModels.isNotEmpty ? double.tryParse(_InvoiceHistoryModels.first.disendbill ?? '0.00') ?? 0.00 : 0.00)}',
                                                      ...
                                                      children: [
                                                        ...
                                                        Expanded(
                                                          ...
                                                          child: AutoSizeText(
                                                            ...
                                                            textAlign:
                                                                TextAlign.end,
                                                            '${nFormat.format(getTotalByField(_InvoiceHistoryModels, (item) => item.total) - (_InvoiceHistoryModels.isNotEmpty ? double.tryParse(_InvoiceHistoryModels.first.disendbill ?? '0.00') ?? 0.00 : 0.00))}',
                                                            style: TextStyle(
                                                                color: PeopleChaoScreen_Color
                                                                    .Colors_Text2_,
                                                                //fontWeight: FontWeight.bold,
