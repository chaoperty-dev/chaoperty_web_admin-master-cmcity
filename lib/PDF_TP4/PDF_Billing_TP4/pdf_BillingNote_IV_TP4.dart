                        ...
                        child: pw.Align(
                          ...
                          child: pw.Text(
                            (tableData003[index][0].toString() == '6')
                                ...
                                : '${tableData003[index][2]} ${DateFormat('MMM', 'th').format(DateTime.parse(tableData003[index][1]))} ${DateTime.parse('${tableData003[index][1]}').year + 543}',
                        ...
                        child: pw.Align(
                          ...
                          child: pw.Text(
                            (tableData003[index][18].toString() == '0.00' ||
                                    tableData003[index][18].toString() == '0')
