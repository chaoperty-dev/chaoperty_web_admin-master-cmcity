...
class Excgen_PeopleChoChoiceReportNew {
  static void exportExcel_PeopleChoChoiceReportNew(
      expModels,
      context,
      NameFile_,
    ...
    sheet.name = 'ข้อมูลพื้นที่เช่า_ผู้เช่า';
    sheet2.name = 'ข้อมูลพื้นที่เช่า';
...
///////////////////////////////----------------------->
    ...
    sheet
        .getRangeByName('A3')
        .setText('พืนที่ทั้งหมด : ${teNantModels.length}');
    sheet
        .getRangeByName('E2')
        .setText('รายงานข้อมูลพื้นที่เช่า/ผู้เช่า (โซน : $zone_name)');
...
// Protecting the Worksheet by using a Password
    ...
    sheet.getRangeByName('A4').setText('รหัสโซน');
    sheet.getRangeByName('B4').setText('รหัสโซน+CMN');
    sheet.getRangeByName('C4').setText('โซนพื้นที่');
    sheet.getRangeByName('D4').setText('รหัสพื้นที่');
    sheet.getRangeByName('E4').setText('ขนาดพื้นที่(ต.ร.ม.)');
    sheet.getRangeByName('F4').setText('ค่าเช่าต่องวด');

    sheet.getRangeByName('G4').setText('เลขที่สัญญา');
    sheet.getRangeByName('H4').setText('เลขที่สัญญาเดิม');
    sheet.getRangeByName('I4').setText('ชื่อผู้ติดต่อ');
    sheet.getRangeByName('J4').setText('TAX/ID');
    sheet.getRangeByName('K4').setText('ที่อยู่');
    sheet.getRangeByName('L4').setText('ประเภทร้านค้า');
    sheet.getRangeByName('M4').setText('เบอร์ติดต่อ');

    sheet.getRangeByName('N4').setText('ระยะเวลาการเช่า');
    sheet.getRangeByName('O4').setText('วันเริ่มสัญญา');
    sheet.getRangeByName('P4').setText('วันสิ้นสุดสัญญา');
    sheet.getRangeByName('Q4').setText('ประเภทสัญญา');
    sheet.getRangeByName('R4').setText('สถานะ');
/////////------------------------------->
    sheet2.getRangeByName('A1').cellStyle = globalStyle22;
    sheet2.getRangeByName('B1').cellStyle = globalStyle22;
    sheet2.getRangeByName('C1').cellStyle = globalStyle22;
    sheet2.getRangeByName('D1').cellStyle = globalStyle22;
    sheet2.getRangeByName('E1').cellStyle = globalStyle22;
    sheet2.getRangeByName('F1').cellStyle = globalStyle22;
    sheet2.getRangeByName('G1').cellStyle = globalStyle22;
    sheet2.getRangeByName('H1').cellStyle = globalStyle22;
    sheet2.getRangeByName('I1').cellStyle = globalStyle22;
    sheet2.getRangeByName('J1').cellStyle = globalStyle22;
    sheet2.getRangeByName('K1').cellStyle = globalStyle22;
    sheet2.getRangeByName('L1').cellStyle = globalStyle22;
    // sheet2.getRangeByName('G1').cellStyle = globalStyle22;
    // sheet2.getRangeByName('H1').cellStyle = globalStyle22;
    // sheet2.getRangeByName('I1').cellStyle = globalStyle22;
    // sheet2.getRangeByName('J1').cellStyle = globalStyle22;
    ...
    sheet2
        .getRangeByName('C2')
        .setText('รายงานข้อมูลพื้นที่เช่า (โซน : $zone_name)');

    sheet2.getRangeByName('A2').cellStyle = globalStyle22;
    sheet2.getRangeByName('B2').cellStyle = globalStyle22;
    sheet2.getRangeByName('C2').cellStyle = globalStyle22;
    sheet2.getRangeByName('D2').cellStyle = globalStyle22;
    sheet2.getRangeByName('E2').cellStyle = globalStyle22;
    sheet2.getRangeByName('F2').cellStyle = globalStyle22;
    sheet2.getRangeByName('G2').cellStyle = globalStyle22;
    sheet2.getRangeByName('H2').cellStyle = globalStyle22;
    sheet2.getRangeByName('I2').cellStyle = globalStyle22;
    sheet2.getRangeByName('J2').cellStyle = globalStyle22;
    sheet2.getRangeByName('K2').cellStyle = globalStyle22;
    sheet2.getRangeByName('L2').cellStyle = globalStyle22;
    // sheet2.getRangeByName('G2').cellStyle = globalStyle22;
    // sheet2.getRangeByName('H2').cellStyle = globalStyle22;
    // sheet2.getRangeByName('I2').cellStyle = globalStyle22;
    // sheet2.getRangeByName('J2').cellStyle = globalStyle22;
    ...
    sheet2.getRangeByName('E3').setText(' ข้อมูล ณ วันที่: ${DateTime.now()}');

    sheet2.getRangeByName('A3').cellStyle = globalStyle22;
    sheet2.getRangeByName('B3').cellStyle = globalStyle22;
    sheet2.getRangeByName('C3').cellStyle = globalStyle22;
    sheet2.getRangeByName('D3').cellStyle = globalStyle22;
    sheet2.getRangeByName('E3').cellStyle = globalStyle22;
    sheet2.getRangeByName('F3').cellStyle = globalStyle22;
    sheet2.getRangeByName('G3').cellStyle = globalStyle22;
    sheet2.getRangeByName('H3').cellStyle = globalStyle22;
    sheet2.getRangeByName('I3').cellStyle = globalStyle22;
    sheet2.getRangeByName('J3').cellStyle = globalStyle22;
    sheet2.getRangeByName('K3').cellStyle = globalStyle22;
    sheet2.getRangeByName('L3').cellStyle = globalStyle22;
    // sheet2.getRangeByName('G3').cellStyle = globalStyle22;
    // sheet2.getRangeByName('H3').cellStyle = globalStyle22;
    // sheet2.getRangeByName('I3').cellStyle = globalStyle22;
    // sheet2.getRangeByName('J3').cellStyle = globalStyle22;
    ...
    sheet2.getRangeByName('G4').cellStyle = globalStyle1;
    sheet2.getRangeByName('H4').cellStyle = globalStyle1;
    sheet2.getRangeByName('I4').cellStyle = globalStyle1;
    sheet2.getRangeByName('J4').cellStyle = globalStyle1;
    sheet2.getRangeByName('K4').cellStyle = globalStyle1;
    sheet2.getRangeByName('L4').cellStyle = globalStyle1;
    // sheet2.getRangeByName('G4').cellStyle = globalStyle1;
    // sheet2.getRangeByName('H4').cellStyle = globalStyle1;
    // sheet2.getRangeByName('I4').cellStyle = globalStyle1;
    // sheet2.getRangeByName('J4').cellStyle = globalStyle1;
    ...
    sheet2.getRangeByName('B4').columnWidth = 18;
    sheet2.getRangeByName('C4').columnWidth = 18;
    sheet2.getRangeByName('D4').columnWidth = 18;
    sheet2.getRangeByName('E4').columnWidth = 18;
    sheet2.getRangeByName('F4').columnWidth = 18;
    sheet2.getRangeByName('G4').columnWidth = 18;
    sheet2.getRangeByName('H4').columnWidth = 18;
    sheet2.getRangeByName('I4').columnWidth = 18;
    sheet2.getRangeByName('L4').columnWidth = 18;
    // sheet2.getRangeByName('G4').columnWidth = 18;
    // sheet2.getRangeByName('H4').columnWidth = 18;
    // sheet2.getRangeByName('I4').columnWidth = 18;
    // sheet2.getRangeByName('J4').columnWidth = 18;
    // sheet2.getRangeByName('K4').columnWidth = 18;
    // sheet2.getRangeByName('L4').columnWidth = 18;
    // sheet.getRangeByName('L4').columnWidth = 18;
    // sheet.getRangeByName('M4').columnWidth = 18;

    sheet2.getRangeByName('A4').setText('ลำดับ');
    sheet2.getRangeByName('B4').setText('รหัสโซนพื้นที่');
    sheet2.getRangeByName('C4').setText('รหัสโซนพื้นที่+CMN');
    sheet2.getRangeByName('D4').setText('โซนพื้นที่');
    sheet2.getRangeByName('E4').setText('รหัสพื้นที่');
    sheet2.getRangeByName('F4').setText('ขนาดพื้นที่(ต.ร.ม.)');
    sheet2.getRangeByName('G4').setText('ค่าเช่าต่องวด');
    sheet2.getRangeByName('H4').setText('ประเภทสัญญา');
    sheet2.getRangeByName('I4').setText('สถานะ');
    sheet2.getRangeByName('J4').setText('วันที่สร้างพื้นที่');
    sheet2.getRangeByName('K4').setText('เวลาสร้างพื้นที่');
    sheet2.getRangeByName('L4').setText('ผู้สร้างพื้นที่');

    // sheet2.getRangeByName('G4').setText('เลขที่สัญญา');
    // sheet2.getRangeByName('H4').setText('ประภทสัญญา');
    // sheet2.getRangeByName('I4').setText('วันที่เริ่มสัญญา');
    // sheet2.getRangeByName('J4').setText('วันที่สิ้นสุดเริ่มสัญญา');
    // sheet2.getRangeByName('K4').setText('สถานะ');
    // sheet2.getRangeByName('L4').setText('ประเภทร้านค้า');
/////////------------------------------->
    for (int i = 0; i < expModels.length; i++) {
      sheet.getRangeByName('${columns[18 + i]}1').cellStyle = globalStyle22;
      sheet.getRangeByName('${columns[18 + i]}2').cellStyle = globalStyle22;
      sheet.getRangeByName('${columns[18 + i]}3').cellStyle = globalStyle22;

      sheet.getRangeByName('${columns[18 + i]}4').cellStyle = globalStyle1;
      sheet.getRangeByName('${columns[18 + i]}4').columnWidth = 35;
      sheet
          .getRangeByName('${columns[18 + i]}4')
    ...
    sheet
        .getRangeByName('${columns[expModels.length + 18]}4')
        .setText('อ้างอิง');

    sheet.getRangeByName('${columns[expModels.length + 18]}1').cellStyle =
        globalStyle22;
    sheet.getRangeByName('${columns[expModels.length + 18]}2').cellStyle =
        globalStyle22;
    sheet.getRangeByName('${columns[expModels.length + 18]}3').cellStyle =
        globalStyle22;
    sheet.getRangeByName('${columns[expModels.length + 18]}4').cellStyle =
        globalStyle1;
    // sheet.getRangeByName('${columns[expModels.length + 18]}4').cellStyle =
    //     globalStyle22;
    ...
    for (int i = 0; i < teNantModels.length; i++) {
      ...
      sheet.getRangeByName('A${i + 5}').setText(
            (teNantModels[index].zn != null)
                ? (teNantModels[index].zn!.split('_')[0].length <= 4)
                    ? '0${teNantModels[index].zn!.split('_')[0]}'
                    : '${teNantModels[index].zn!.split('_')[0]}'
                : (teNantModels[index].zn1!.split('_')[0].length <= 4)
                    ? '0${teNantModels[index].zn1!.split('_')[0]}'
                    : '${teNantModels[index].zn1!.split('_')[0]}',
          );
      ...
      sheet.getRangeByName('F${i + 5}').setText(
            teNantModels[i].rent == null ? '' : '${teNantModels[i].rent}',
          );
      ...
      try {
        sheet.getRangeByName('O${index + 5}').cellStyle.numberFormat =
            'dd-MM-yyyy';
        sheet.getRangeByName('O${index + 5}').setValue(
      ...
      try {
        sheet.getRangeByName('P${index + 5}').cellStyle.numberFormat =
            'dd-MM-yyyy';
        sheet.getRangeByName('P${index + 5}').setValue(
      ...
      if (teNantModels[i].ldate == null ||
          teNantModels[i].ldate.toString() == '' ||
          teNantModels[i].ldate.toString() == 'null') {
        sheet.getRangeByName('R${i + 5}').setText('ว่าง');
      } else {
...
// Check if textdata is not null or empty, and then decode
    ...
    for (int index = 0; index < teNantModels.length; index++) {
      ...
      sheet2.getRangeByName('G${index + 5}').cellStyle = numberColor;
      sheet2.getRangeByName('H${index + 5}').cellStyle = numberColor;
      sheet2.getRangeByName('I${index + 5}').cellStyle = numberColor;
      sheet2.getRangeByName('J${index + 5}').cellStyle = numberColor;
      sheet2.getRangeByName('K${index + 5}').cellStyle = numberColor;
      sheet2.getRangeByName('L${index + 5}').cellStyle = numberColor;

      sheet2.getRangeByName('A${index + 5}').setText('${index + 1}');
      sheet2
          .getRangeByName('B${index + 5}')
          .setText(sheet.getRangeByName('A${index + 5}').text);

      sheet2
          .getRangeByName('C${index + 5}')
          .setText(sheet.getRangeByName('B${index + 5}').text);

      sheet2
          .getRangeByName('D${index + 5}')
          .setText(sheet.getRangeByName('C${index + 5}').text);
      sheet2
          .getRangeByName('E${index + 5}')
          .setText(sheet.getRangeByName('D${index + 5}').text);
      sheet2
          .getRangeByName('F${index + 5}')
          .setText(sheet.getRangeByName('E${index + 5}').text);
      sheet2
          .getRangeByName('G${index + 5}')
          .setText(sheet.getRangeByName('F${index + 5}').text);
      sheet2
          .getRangeByName('H${index + 5}')
          .setText(sheet.getRangeByName('Q${index + 5}').text);
      sheet2
          .getRangeByName('I${index + 5}')
          .setText(sheet.getRangeByName('R${index + 5}').text);
      // sheet2.getRangeByName('J${index + 5}').setText(
      //       (teNantModels[index].datex == null ||
      //               teNantModels[index].datex.toString() == '' ||
      //               teNantModels[index].datex.toString() == 'null')
      //           ? ''
      //           : '${teNantModels[index].datex}',
      //     );
      try {
        sheet2.getRangeByName('J${index + 5}').cellStyle.numberFormat =
            'dd-MM-yyyy';
        sheet2.getRangeByName('J${index + 5}').setValue(
              (teNantModels[index].datex == null ||
                      teNantModels[index].datex.toString() == '' ||
                      teNantModels[index].datex.toString() == 'null')
                  ? null
                  : DateTime.parse('${teNantModels[index].datex}'),
            );
      } catch (e) {
        sheet2.getRangeByName('J${index + 5}').setText((teNantModels[index]
                        .datex ==
                    null ||
                teNantModels[index].datex.toString() == '' ||
                teNantModels[index].datex.toString() == 'null')
            ? ''
            : '${DateFormat('dd-MM-yyyy').format(DateTime.parse('${teNantModels[index].datex}'))}');
      }
      sheet2.getRangeByName('K${index + 5}').setText(
            (teNantModels[index].timex == null ||
                    teNantModels[index].timex.toString() == '' ||
                    teNantModels[index].timex.toString() == 'null')
                ? ''
                : '${teNantModels[index].timex}',
          );
      sheet2.getRangeByName('L${index + 5}').setText(
    ...
    if (_verticalGroupValue_NameFile.toString() == 'จากระบบ') {
      String path = await FileSaver.instance.saveFile(
          "รายงานข้อมูลพื้นที่เช่า_ผู้เช่า(โซน$zone_name)", data, "xlsx",
          mimeType: type);
      log(path);
    } else {
