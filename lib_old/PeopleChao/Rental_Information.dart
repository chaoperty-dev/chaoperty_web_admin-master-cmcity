...
class _RentalInformationState extends State<RentalInformation> {
  ...
  final Form_areaaddrx = TextEditingController();
  final Form_stime = TextEditingController();
  final Form_ltime = TextEditingController();
...
/////////----------------------------------------->
  ...
  final Contract_num = TextEditingController();
...
//////-------------------------->
  ...
  final TextEditingController readtypes_Controller = TextEditingController();
  final TextEditingController areatypes_Controller = TextEditingController();
      ...
      if (result != null) {
        for (var map in result) {
          ...
          setState(() {
            ...
            Form_areaaddrx.text = teNantModel.addrx.toString();
            areatypes_Controller.text = teNantModel.areatype.toString();
            isMon = int.tryParse(teNantModel.is_mon ?? "") ?? 0;
            isTue = int.tryParse(teNantModel.is_tue ?? "") ?? 0;
            isWed = int.tryParse(teNantModel.is_wed ?? "") ?? 0;
            isThu = int.tryParse(teNantModel.is_thu ?? "") ?? 0;
            isFri = int.tryParse(teNantModel.is_fri ?? "") ?? 0;
            isSat = int.tryParse(teNantModel.is_sat ?? "") ?? 0;
            isSun = int.tryParse(teNantModel.is_sun ?? "") ?? 0;
            Form_stime.text = teNantModel.stime.toString();
            Form_ltime.text = teNantModel.ltime.toString();
          });
        }
        read_GC_TypePaper();
        red_coutumer();
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: EditContractForm(
                      ...
                      Form_areaaddrx: Form_areaaddrx,
                      Form_stime: Form_stime,
                      Form_ltime: Form_ltime,
