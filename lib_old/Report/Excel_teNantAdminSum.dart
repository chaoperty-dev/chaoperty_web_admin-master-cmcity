...
class Excgen_teNantAdminSum_Report {
  static void exportExcel_teNantAdminSum_Report(context, renTal_name,
      teNantModels_AdminSum, zone_name_Admin_teNantSum) async {
...
////////////-------------------------------------------------------->
    ...
    final x.Range range = sheet.getRangeByName('C1');
    range.setText(
...
// Protecting the Worksheet by using a Password
    ...
    sheet.getRangeByName('E4').setText('สถานะ');
    sheet.getRangeByName('F4').setText('จำนวนสัญญา');
    ...
    int indextotol = 0;
    String? useradmin;
    for (var index = 0; index < teNantModels_AdminSum.length; index++) {
      ...
      sheet.getRangeByName('C${index + 5}').setText(
            (teNantModels_AdminSum[index].admin_name == null)
                ? '-'
                : '${teNantModels_AdminSum[index].admin_name}',
          );
      sheet.getRangeByName('D${index + 5}').setText(
            (teNantModels_AdminSum[index].admin_email == null)
                ? '-'
      ...
      sheet.getRangeByName('F${index + 5}').setNumber(
            (teNantModels_AdminSum[index].total_cid == null)
                ? 0.00
                : double.parse('${teNantModels_AdminSum[index].total_cid}'),
          );
