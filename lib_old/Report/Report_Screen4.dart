...
//         ? '${MyConstant().domain}/GC_bill_pay_BC_IncomeTaxReport_All.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon&seruser=$user_ser_Trans_Mon'
//         : '${MyConstant().domain}/GC_bill_pay_BC_IncomeTaxReport.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon&seruser=$user_ser_Trans_Mon';

//     String url_Daily = (zone_ser_Trans_Daily.toString() == '0')
//         ? '${MyConstant().domain}/GC_bill_pay_BC_DailyTaxReport_All.php?isAdd=true&ren=$ren&date=$Value_TransDate_Daily&serzone=$zone_ser_Trans_Daily&seruser=$user_ser_Trans_Daily'
//         : '${MyConstant().domain}/GC_bill_pay_BC_DailyTaxReport.php?isAdd=true&ren=$ren&date=$Value_TransDate_Daily&serzone=$zone_ser_Trans_Daily&seruser=$user_ser_Trans_Daily';
...
//     ///-------->
//     String url_Mon = (zone_ser_Trans_Mon.toString() == '0')
//         ? '${MyConstant().domain}/GC_bill_pay_BC_BankmovemenTaxReport_All.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon&seruser=$user_ser_Trans_Mon'
//         : '${MyConstant().domain}/GC_bill_pay_BC_BankmovemenTaxReport.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon&seruser=$user_ser_Trans_Mon';

//     String url_Daily = (zone_ser_Trans_Daily.toString() == '0')
//         ? '${MyConstant().domain}/GC_bill_pay_BC_Bank_DailyTaxReport_All.php?isAdd=true&ren=$ren&date=$Value_TransDate_Daily&serzone=$zone_ser_Trans_Daily&seruser=$user_ser_Trans_Daily'
//         : '${MyConstant().domain}/GC_bill_pay_BC_Bank_DailyTaxReport.php?isAdd=true&ren=$ren&date=$Value_TransDate_Daily&serzone=$zone_ser_Trans_Daily&seruser=$user_ser_Trans_Daily';
...
//         ? '${MyConstant().domain}/GC_bill_pay_historyselectBankAllTaxReport.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$serzone_s&datex=$Value_TransDate_Daily&Typesearch=$Type_search&seruser=$seruser_s'
//         : '${MyConstant().domain}/GC_bill_pay_historyselectAllTaxReport.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$serzone_s&datex=$Value_TransDate_Daily&Typesearch=$Type_search&seruser=$seruser_s';
//     try {
//       var response = await http.get(Uri.parse(url));
...
//                                         'กดดูรายงานรายรับ(เฉพาะรายการที่ออกใบกำกับภาษี)');
//                                     TransIncome_Widget();
//                                   },
//                             child: Container(
//                               decoration: BoxDecoration(
...
//                                 : () async {
//                                     Insert_log.Insert_logs('รายงาน',
//                                         'กดดูรายงานการเคลื่อนไหวธนาคาร(เฉพาะรายการที่ออกใบกำกับภาษี)');
...
//                                 : () async {
//                                     Insert_log.Insert_logs('รายงาน',
//                                         'กดดูรายงานรายรับประจำวัน(เฉพาะรายการที่ออกใบกำกับภาษี)');
//                                     TransIncome_Widget();
//                                   }),
//                         (Type_search != 'Daily')
//                             ? Padding(
...
//                                 : () async {
//                                     Insert_log.Insert_logs('รายงาน',
//                                         'กดดูรายงานการเคลื่อนไหวธนาคารประจำวัน(เฉพาะรายการที่ออกใบกำกับภาษี)');
//                                     TransIncomeBank_Widget();
//                                   }),
//                         (Type_search != 'Daily')
//                             ? Padding(
