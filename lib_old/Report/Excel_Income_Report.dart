...
// Protecting the Worksheet by using a Password
    ...
    sheet.getRangeByName('Z4').setText('รหัสแอดมินผู้ทำรายการ');
      ...
      if (matchingItems.isNotEmpty) {
        ...
        matchingItems.forEach((item) {
          ...
          sheet.getRangeByName('J${indextotol + 5 - 1}').setText(
              (TranHisBillModels[index2].cname == null)
                  ? '${TranHisBillModels[index2].remark}'
                  : '${TranHisBillModels[index2].cname}');
          ...
          sheet.getRangeByName('O${indextotol + 5 - 1}').setNumber(
              double.parse(item.total_bill!) + double.parse(item.total_dis!));
          ...
          sheet.getRangeByName('Q${indextotol + 5 - 1}').setNumber(
              (item.total_dis == null) ? 0.00 : double.parse(item.total_bill!)
              // (item.total_dis == null)
    ...
    for (var index = 0; index < userModels.length; index++) {
      if (userModels[index].ser.toString() == '0') {
        ...
        sheet2.getRangeByName('E${index + 2}').setFormula(
            '=${TransReBillModels.length}-SUM(E${index + 3}:E${userModels.length + 1})');
        ...
        sheet2.getRangeByName('E${index + 2}').setFormula(
            '=COUNTIFS(Sheet1!Z5:Sheet1!Z${indextotol + 5 - 1},  "${userModels[index].ser}", Sheet1!I5:Sheet1!I${indextotol + 5 - 1}, "ยอดรวมทั้งบิล")');

        sheet2.getRangeByName('F${index + 2}').setFormula(
            '=SUMIFS(Sheet1!N5:Sheet1!N${indextotol + 5 - 1}, Sheet1!Z5:Sheet1!Z${indextotol + 5 - 1}, "${userModels[index].ser}", Sheet1!I5:Sheet1!I${indextotol + 5 - 1}, "ยอดรวมทั้งบิล")');

        sheet2.getRangeByName('G${index + 2}').setFormula(
            '=SUMIFS(Sheet1!O5:Sheet1!O${indextotol + 5 - 1}, Sheet1!Z5:Sheet1!Z${indextotol + 5 - 1}, "${userModels[index].ser}", Sheet1!I5:Sheet1!I${indextotol + 5 - 1}, "ยอดรวมทั้งบิล")');

        sheet2.getRangeByName('H${index + 2}').setFormula(
            '=SUMIFS(Sheet1!P5:Sheet1!P${indextotol + 5 - 1},Sheet1!Z5:Sheet1!Z${indextotol + 5 - 1}, "${userModels[index].ser}", Sheet1!I5:Sheet1!I${indextotol + 5 - 1}, "ยอดรวมทั้งบิล")');

        sheet2.getRangeByName('I${index + 2}').setFormula(
            '=SUMIFS(Sheet1!Q5:Sheet1!Q${indextotol + 5 - 1}, Sheet1!Z5:Sheet1!Z${indextotol + 5 - 1}, "${userModels[index].ser}", Sheet1!I5:Sheet1!I${indextotol + 5 - 1}, "ยอดรวมทั้งบิล")');
      }
