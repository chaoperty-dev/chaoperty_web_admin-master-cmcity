...
//
// ใช้ LaColors theme tokens เพื่อให้สอดคล้องกับ UI อื่นๆ ใน license_attach_page
// ============================================================================
...
class AttachFilePreviewDialog extends StatefulWidget {
  /// รายการ attachments ทั้งหมดที่จะให้ browse
  final List<LicenseAttachAttachment> attachments;
  ...
  static Future<void> show(
    ...
    required LicenseAttachAttachment attachment,
    String? title,
  }) {
  ...
  static Future<void> showGallery(
    BuildContext context, {
    required List<LicenseAttachAttachment> attachments,
    int initialIndex = 0,
    String? title,
    List<String?>? titles,
  }) {
  ...
  @override
  State<AttachFilePreviewDialog> createState() =>
      _AttachFilePreviewDialogState();
}

class _AttachFilePreviewDialogState extends State<AttachFilePreviewDialog> {
  ...
  LicenseAttachAttachment get _currentAttachment =>
  ...
  bool _isImage(LicenseAttachAttachment att) {
  ...
  bool _isPdf(LicenseAttachAttachment att) {
    final fileType = (att.fileType ?? '').toString().toLowerCase();
    final fileName =
        (att.fileName ?? att.filePath ?? '').toString().toLowerCase();
  ...
  IconData _getIcon(LicenseAttachAttachment att) {
  ...
  Color _getPrimaryColor(LicenseAttachAttachment att) {
  ...
  Color _getSoftColor(LicenseAttachAttachment att) {
  ...
  String _getTypeLabel(LicenseAttachAttachment att) {
...
class _ImageViewer extends StatefulWidget {
  final LicenseAttachAttachment attachment;
...
class _ImageViewerState extends State<_ImageViewer>
  ...
  Future<void> _loadBytes() async {
    ...
    final bytes =
        await AttachDocumentsService().fetchAttachmentBytes(widget.attachment);
    if (!mounted) return;
    setState(() {
      _bytes = bytes;
      _isLoading = false;
