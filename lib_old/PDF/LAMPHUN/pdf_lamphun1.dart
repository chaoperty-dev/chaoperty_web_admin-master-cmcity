...
class Pdfgen_Agreementlamphun1 {
//////////---------------------------------------------------->( **** เอกสารสัญญาห้องเช่า  )

  static void exportPDF_Agreementlamphun1(
      context,
        ...
        build: (context) {
          return [
            pw.Row(
              ...
              children: [
                Textx(
                    value: 'สัญญาห้องเช่าในตลาดลำพูนจตุจักร',
                    font: ttf,
            ...
            pw.Row(children: [
              Textx(
                  value:
                      '${' ' * 24}ผู้ให้เช่าตาลงให้เช่าและผู้เช่าตกลงเช่า ห้องเช่าในตลาดลำพูนจตุจักรเลขที่ ',
                  font: ttf),
              labeledLine1(value: bill_addr, font: ttf, flex: 1),
            ]),
            pw.Row(children: [
              Textx(
                  value: 'ซึ่งต่อไปในสัญญาเรียกว่า  “ห้องเช่า”  หมายเลขล็อค',
                  font: ttf),
            ...
            pw.Row(children: [
              Textx(
                  value:
                      '${' ' * 30}3.4.1 เวลาเปิด-ปิด  ร้านค้าคือตั้งแต่เวลา  09.00 น.  ถึง  20.00 น.   หากมีเหตุผลจำเป็นต้องปิดร้านชั่วคราวผู้เช่าจะต้องยื่นใบแจ้งขอปิดร้าน',
                  font: ttf),
            ]),
            Textx(
                value: 'ชั่วคราว โดยระบุวันปิดและวันเปิดร้านทุกครั้งด้วย',
                font: ttf),
            pw.Row(children: [
              Textx(
                  value:
                      '${' ' * 30}3.4.2   ลานจอดรถบริเวณภายในขอบเขตตลาด    เป็นพื้นที่จอดรถยนต์เฉพาะสำหรับลูกค้า   ที่มาใช้บริการของตลาด   ลำพูนจตุจักรเท่านั้น',
                  font: ttf),
            ]),
            pw.Row(children: [
              labeledLine1(
                  value:
                      'ผู้เช่าและบริวารไม่มีสิทธิ์นำรถยนต์ของตนเข้าไปจอดในพื้นที่ดังกล่าว',
                  font: ttf,
                  flex: 2),
              Textx(
                  value:
                      ' หากผู้เช่าตรวจพบว่าผู้เช่าหรือบริวารฝ่าฝืน ผู้ให้เช่าถือว่ามีเจตนาผิดสัญญาเช่าในส่วนที่เป็น',
                  font: ttf),
            ]),
            Textx(
                value:
                    'สาระสำคัญหากหากเป็นการฝ่าฝืนครั้งที่สองสัญญาเช่านี้เป็นอันระงับลงทันที',
                font: ttf),
            pw.Spacer(),
            pw.Align(
            ...
            Textx(
                value:
                    '${' ' * 24}เพื่อเป็นหลักฐานว่าตามที่ข้าพเจ้าได้เช่า   "ห้องเช่า"   ของบริษัท   บริษัท   ลำพูนจตุจักร  จำกัด   ตามสัญญาเช่าพื้นที่เช่าในตลาดลำพูนจตุจักร',
                font: ttf),
            pw.Row(children: [
