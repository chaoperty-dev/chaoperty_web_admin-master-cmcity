...
class Excgen_transMeterChoiceReport {
  static void exportExcel_transMeterChoiceReport(
      context,
      NameFile_,
...
////////////-------------------------------------------------------->
    ...
    sheet.getRangeByName('A1:AB1').merge();
    ...
    sheet
        .getRangeByName('A2')
        .setText('เดือน ${Mon_transMeter_Mon}/${YE_transMeter_Mon}');
    ...
    sheet.getRangeByName('A5').setText('ทั้งหมด :${transMeterModels.length}');
    sheet.getRangeByName('H5').setText('อัพเดต ณ :${DateTime.now()}');

    sheet.getRangeByName('A1').cellStyle = globalStyle220;
    sheet.getRangeByName('B1').cellStyle = globalStyle220;
    sheet.getRangeByName('C1').cellStyle = globalStyle220;
    sheet.getRangeByName('D1').cellStyle = globalStyle220;
    sheet.getRangeByName('E1').cellStyle = globalStyle220;
    sheet.getRangeByName('F1').cellStyle = globalStyle220;
    sheet.getRangeByName('G1').cellStyle = globalStyle220;
    sheet.getRangeByName('H1').cellStyle = globalStyle220;
    sheet.getRangeByName('I1').cellStyle = globalStyle220;
    sheet.getRangeByName('J1').cellStyle = globalStyle220;
    sheet.getRangeByName('K1').cellStyle = globalStyle220;
    sheet.getRangeByName('L1').cellStyle = globalStyle220;
    sheet.getRangeByName('M1').cellStyle = globalStyle220;
    sheet.getRangeByName('N1').cellStyle = globalStyle220;
    sheet.getRangeByName('O1').cellStyle = globalStyle220;
    sheet.getRangeByName('P1').cellStyle = globalStyle220;
...
// Protecting the Worksheet by using a Password
    ...
    sheet.getRangeByName('A2').cellStyle = globalStyle220;
    sheet.getRangeByName('B2').cellStyle = globalStyle220;
    sheet.getRangeByName('C2').cellStyle = globalStyle220;
    sheet.getRangeByName('D2').cellStyle = globalStyle220;
    sheet.getRangeByName('E2').cellStyle = globalStyle220;
    sheet.getRangeByName('F2').cellStyle = globalStyle220;
    sheet.getRangeByName('G2').cellStyle = globalStyle220;
    sheet.getRangeByName('H2').cellStyle = globalStyle220;
    sheet.getRangeByName('I2').cellStyle = globalStyle220;
    sheet.getRangeByName('J2').cellStyle = globalStyle220;
    sheet.getRangeByName('K2').cellStyle = globalStyle220;
    sheet.getRangeByName('L2').cellStyle = globalStyle220;
    sheet.getRangeByName('M2').cellStyle = globalStyle220;
    sheet.getRangeByName('N2').cellStyle = globalStyle220;
    sheet.getRangeByName('O2').cellStyle = globalStyle220;
    sheet.getRangeByName('P2').cellStyle = globalStyle220;
    ...
    sheet.getRangeByName('A3').cellStyle = globalStyle220;
    sheet.getRangeByName('B3').cellStyle = globalStyle220;
    sheet.getRangeByName('C3').cellStyle = globalStyle220;
    sheet.getRangeByName('D3').cellStyle = globalStyle220;
    sheet.getRangeByName('E3').cellStyle = globalStyle220;
    sheet.getRangeByName('F3').cellStyle = globalStyle220;
    sheet.getRangeByName('G3').cellStyle = globalStyle220;
    sheet.getRangeByName('H3').cellStyle = globalStyle220;
    sheet.getRangeByName('I3').cellStyle = globalStyle220;
    sheet.getRangeByName('J3').cellStyle = globalStyle220;
    sheet.getRangeByName('K3').cellStyle = globalStyle220;
    sheet.getRangeByName('L3').cellStyle = globalStyle220;
    sheet.getRangeByName('M3').cellStyle = globalStyle220;
    sheet.getRangeByName('N3').cellStyle = globalStyle220;
    sheet.getRangeByName('O3').cellStyle = globalStyle220;
    sheet.getRangeByName('P3').cellStyle = globalStyle220;

    sheet.getRangeByName('A4').cellStyle = globalStyle220;
    sheet.getRangeByName('B4').cellStyle = globalStyle220;
    sheet.getRangeByName('C4').cellStyle = globalStyle220;
    sheet.getRangeByName('D4').cellStyle = globalStyle220;
    sheet.getRangeByName('E4').cellStyle = globalStyle220;
    sheet.getRangeByName('F4').cellStyle = globalStyle220;
    sheet.getRangeByName('G4').cellStyle = globalStyle220;
    sheet.getRangeByName('H4').cellStyle = globalStyle220;
    sheet.getRangeByName('I4').cellStyle = globalStyle220;
    sheet.getRangeByName('J4').cellStyle = globalStyle220;
    sheet.getRangeByName('K4').cellStyle = globalStyle220;
    sheet.getRangeByName('L4').cellStyle = globalStyle220;
    sheet.getRangeByName('M4').cellStyle = globalStyle220;
    sheet.getRangeByName('N4').cellStyle = globalStyle220;
    sheet.getRangeByName('O4').cellStyle = globalStyle220;
    sheet.getRangeByName('P4').cellStyle = globalStyle220;
    ...
    sheet.getRangeByName('B6').setText('รหัสโซน');
    sheet.getRangeByName('C6').setText('โซน');
    sheet.getRangeByName('D6').setText('รหัสพื้นที่');
    sheet.getRangeByName('E6').setText('เลขที่สัญญา');
    sheet.getRangeByName('F6').setText('ชื่อผู้เช่า');
    sheet.getRangeByName('G6').setText('รายการ');
    sheet.getRangeByName('H6').setText('วันที่');

    sheet.getRangeByName('I6').setText(
          'หมายเลขเครื่อง',
        );
    sheet.getRangeByName('J6').setText(
    ...
    sheet.getRangeByName('K6').setText((transMeterModels.length == 0 ||
            transMeterModels[0].date == null ||
            transMeterModels[0].date.toString() == '')
        ? 'เลขมิเตอร์เดือน(??)'
        : 'เลขมิเตอร์เดือน(${DateFormat.MMM('th_TH').format(DateTime.parse('${transMeterModels[0].date}'))})');
    sheet.getRangeByName('L6').setText(
          'หน่วยที่ใช้',
        );
    sheet.getRangeByName('M6').setText(
          'ราคาต่อหน่วย',
        );
    sheet.getRangeByName('N6').setText(
          'รวม Vat',
        );
    sheet.getRangeByName('O6').setText(
          'หลักฐาน',
        );
    sheet.getRangeByName('P6').setText(
          'สถานะ',
        );
    int index1 = 0;
    String Cid_now = '';
    for (int index = 0; index < transMeterModels.length; index++) {
      ...
      sheet.getRangeByName('B${index + 7}').setText(
            (transMeterModels[index].zn != null)
                ? (transMeterModels[index].zn!.split('_')[0].length <= 4)
                    ? 'CMN0${transMeterModels[index].zn!.split('_')[0]}'
                    : 'CMN${transMeterModels[index].zn!.split('_')[0]}'
                : (transMeterModels[index].zn1!.split('_')[0].length <= 4)
                    ? 'CMN0${transMeterModels[index].zn1!.split('_')[0]}'
                    : 'CMN${transMeterModels[index].zn1!.split('_')[0]}',
          );
      ...
      try {
        ...
        sheet.getRangeByName('H${index + 7}').setValue(
              (transMeterModels[index].date == null ||
                  ...
                  ? null
                  : DateTime.parse('${transMeterModels[index].date} 00:00:00'),
            );
      } catch (e) {
      ...
      sheet
          ...
          .setText('${transMeterModels[index].st}');
    }
    ...
    //     globalStyle7;
    sheet.getRangeByName('K${transMeterModels.length + 7}').cellStyle =
        globalStyle7;
    sheet.getRangeByName('L${transMeterModels.length + 7}').cellStyle =
        globalStyle7;
    sheet.getRangeByName('M${transMeterModels.length + 7}').cellStyle =
        globalStyle7;
    sheet.getRangeByName('N${transMeterModels.length + 7}').cellStyle =
        globalStyle7;

    sheet.getRangeByName('K${transMeterModels.length + 7}').setText(
          'รวม',
        );
    sheet.getRangeByName('L${transMeterModels.length + 7}').setFormula(
          '=SUM(J5:J${transMeterModels.length + 7 - 1})',
        );
    // sheet.getRangeByName('L${transMeterModels.length + 5}').setFormula(
    //       '=SUM(K5:K${transMeterModels.length + 5 - 1})',
    //     );
    sheet.getRangeByName('N${transMeterModels.length + 7}').setFormula(
          '=SUM(L5:L${transMeterModels.length + 7 - 1})',
        );
    ...
    var name_File = (zone_name_transMeter == null)
        ? (expSZ_name.toString().trim() != 'ทั้งหมด')
            ? 'รายงาน$expSZ_name(กรุณาเลือกโซน)'
            : 'รายงานมิเตอร์น้ำ_ไฟฟ้า(กรุณาเลือกโซน)'
        : (expSZ_name.toString().trim() != 'ทั้งหมด')
            ? 'รายงานมิเตอร์น้ำ_ไฟฟ้า(โซน : $zone_name_transMeter)'
            : 'รายงานมิเตอร์น้ำ_ไฟฟ้า(โซน : $zone_name_transMeter)';
