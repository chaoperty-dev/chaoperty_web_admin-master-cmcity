...
class Pdfgen_Agreementnim6 {
//////////---------------------------------------------------->( **** เอกสารสัญญาเช่า ปกติ  )

  static void exportPDF_Agreementnim6(
      context,
          ...
          return [
            ...
            pw.Column(children: [
              pw.Row(children: [
                Textx(
                    value:
                        '            ตามที่คู่สัญญาทั้งสองฝ่าย ได้ตกลงทำสัญญาเช่าทรัพย์สิน และได้กำหนดระยะเวลาอายุสัญญาการเช่าพื้นที่ใน',
                    font: ttf),
                labeledLine1(
                  flex: 1,
                  value: '$Form_ln',
              ...
              pw.Row(children: [
                ...
                Textx(
                    value:
                        'ตารางเมตร ซึ่งตั้งอยู่เลขที่ 199/8 ถนนมหิดล ตำบลหายยา อำเภอเมืองเชียงใหม่ ',
                    font: ttf),
              ]),
            ]),
            pw.Row(children: [
              Textx(
                  value: 'จังหวัดเชียงใหม่ 50100 เริ่มตั้งแต่วันที่',
                  font: ttf),
              labeledLine1(
                flex: 1,
            ...
            pw.Row(children: [
              Textx(
                  value: 'รายละเอียดปรากฏตามหนังสือสัญญาเช่าพื้นที่ เลขที่',
                  font: ttf),
              labeledLine1(
                flex: 1,
                value: (() {
            ...
            pw.Column(children: [
              pw.Row(children: [
                Textx(
                    value:
                        '            ทั้งสองฝ่ายตกลงทำเอกสารแนบท้ายสัญญาโดยมีข้อความ เงื่อนไขและรายละเอียด ดังต่อไปนี้',
                    font: ttf),
              ]),
              pw.Row(children: [
                Textx(
                    value:
                        '            1.  ผู้ให้เช่าตกลงให้เช่าและผู้เช่าตกลงเช่าพื้นที่บริเวณเสาที่ใช้สำหรับติดตั้งป้ายหน้าศูนย์การค้านิ่มซิตี้รวมขนาดพื้นที่จำนวน',
                    font: ttf),
              ]),
              pw.Row(children: [
                labeledLine1(flex: 1, value: remark, font: ttf),
                Textx(
                    value: 'โดยมีวัตถุประสงค์ เพื่อใช้ติดตั้งป้ายไฟขนาด',
                    font: ttf),
                labeledLine1(flex: 1, value: remark, font: ttf),
              ]),
              pw.Row(children: [
                Textx(
                    value:
                        'ในการประกอบกิจการของผู้เช่า โดยการเช่ามีกำหนดระยะเวลาเช่าทั้งสิ้น',
                    font: ttf),
                labeledLine1(
                  flex: 1,
                  value: '$Form_period',
              ...
              pw.Row(children: [
                ...
                Textx(value: '(ราคานี้ยังไม่รวมภาษีมูลค่าเพิ่ม)', font: ttf),
              ]),
              pw.Row(children: [
                Textx(
                    value: ' ให้แก่ผู้ให้เช่าเป็นรายเดือนตลอดอายุสัญญาเช่า',
                    font: ttf),
              ]),
              pw.SizedBox(height: 2 * PdfPageFormat.mm),
              pw.Row(children: [
                Textx(
                    value:
                        '            2.  ทั้งนี้ค่าใช้จ่ายดังกล่าวข้างต้นผู้เช่าตกลงทำการชำระให้แก่ผู้ให้เช่าเป็นรายเดือนโดยผู้เช่ายินยอมที่จะชำระค่าเช่าป้ายดัง',
                    font: ttf),
              ]),
              pw.Row(children: [
                Textx(
                    value:
                        'กล่าวให้แก่ผู้ให้เช่าทุกวันที่ 1-5 ของทุกเดือน โดยวิธีชำระผ่านบัญชี ธนาคารกรุงไทย จำกัด(มหาชน) สาขา สี่แยกสนามบินเชียงใหม่',
                    font: ttf),
              ]),
              pw.Row(children: [
                Textx(
                    value:
                        'ประเภทบัญชี ออมทรัพย์ เลขที่บัญชี 771-0-01967-6 ชื่อบัญชี บริษัท นิ่มซิตี้เดลี่ จำกัด หรือตามวิธีที่ผู้ให้เช่ากำหนด',
                    font: ttf),
              ]),
              pw.SizedBox(height: 2 * PdfPageFormat.mm),
              pw.Row(children: [
                Textx(
                    value:
                        '            3.  ตามเอกสารแนบท้ายสัญญาฉบับนี้  หน้าที่ทำการชำระและรับผิดชอบค่าภาษีโรงเรือน,  ที่ดิน,  ภาษีป้าย  ที่เกี่ยวข้องกับ',
                    font: ttf),
              ]),
              pw.Row(children: [
                Textx(
                    value:
                        'ทรัพย์สินที่เช่า รวมทั้งค่าใช้จ่ายอื่น ๆ ที่เกิดขึ้นและเกี่ยวข้องกับทรัพย์สินที่เช่า เช่น ค่าไฟฟ้า เป็นต้น คู่สัญญาทั้งสองฝ่ายตกลงให้ผู้เช่า',
                    font: ttf),
              ]),
              pw.Row(children: [
                Textx(
                    value: 'เป็นผู้รับผิดชอบแต่เพียงฝ่ายเดียวทั้งสิ้น',
                    font: ttf),
              ]),
              pw.SizedBox(height: 2 * PdfPageFormat.mm),
              pw.Row(children: [
                Textx(
                    value:
                        '            4.  คู่สัญญาทั้งสองฝ่ายตกลง ยอมรับ ให้ใช้เงื่อนไขหรือข้อตกลงอื่น ๆ บังคับตามสัญญาหลัก เลขที่',
                    font: ttf),
                labeledLine1(
                  flex: 1,
                  value: (() {
              ...
              pw.Row(children: [
                ...
                Textx(value: ' ที่กล่าวอ้างถึงข้างต้น', font: ttf),
              ]),
            ]),
            pw.NewPage(),
            pw.Row(
