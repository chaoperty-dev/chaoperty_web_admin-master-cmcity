...
class PreviewPdfgen_Bills extends StatefulWidget {
  ...
  @override
  State<PreviewPdfgen_Bills> createState() => _PreviewPdfgen_BillsState();
}

class _PreviewPdfgen_BillsState extends State<PreviewPdfgen_Bills> {
  ...
  String _pdfName() => _safeFileName('${widget.nameBills ?? 'เอกสาร'}');
  ...
  Widget build(BuildContext context) {
    final appTitle = widget.nameBills ?? 'เอกสาร';
