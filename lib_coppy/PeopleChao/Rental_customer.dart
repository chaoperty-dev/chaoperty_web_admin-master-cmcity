      ...
      builder: (BuildContext dialogContext) {
        return StatefulBuilder(
          builder: (ctx, setState) {
            ...
            // https://liff.line.me/2007879464-R2QmvaO5?ren=139&username=ODUwMDY4NDAwNTM2MQ
        ...
        return StatefulBuilder(
          builder: (ctx, setStateDialog) {
            ...
            Future<void> _delete({required bool onlyLine}) async {
              ...
              bool isClosing = false; // 1. เพิ่มตัวแปรเช็คสถานะ
              try {
                final prefs = await SharedPreferences.getInstance();
                ...
                if (ok) {
                  ...
                  isClosing = true; // 2. ระบุว่าสำเร็จแล้ว และกำลังจะปิด Dialog
                ...
                // 3. สั่ง setState เฉพาะตอนที่ไม่ได้กำลังจะปิด Dialog
                if (ctx.mounted && !isClosing) {
            ...
            Future<void> _savePassword() async {
              ...
              try {
                ...
                if (ok) {
                  await read_GC_tenantnew();
                  isClosing = true; // 2. ระบุว่ากำลังจะปิด Dialog
                  WidgetsBinding.instance.addPostFrameCallback((_) {
                    final n = Navigator.of(ctx);
                    if (n.canPop()) n.pop();
                  });
    ...
    return (Status_cuspang == 1)
        ...
        : LayoutBuilder(
            builder: (context, cts) {
              ...
              final tableMinW =
                  Responsive.isDesktop(context) ? screenW - 20 : 980.0;
