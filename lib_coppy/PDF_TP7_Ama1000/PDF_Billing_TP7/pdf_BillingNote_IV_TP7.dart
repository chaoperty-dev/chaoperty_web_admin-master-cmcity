...
class Pdfgen_BillingNoteInvlice_TP7_Ama {
  //////////---------------------------------------------------->(ใบวางบิล แจ้งหนี้)  ใช้  ++
  static void exportPDF_BillingNoteInvlice_TP7_Ama(
          ...
          ? pw.Expanded(
              ...
              children: [
                pw.Padding(
                  ...
                  child: pw.Text(
                    '1. โปรดชำระเงินไม่เกินวันที่ 10 ของเดือนถัดไป หากเกิดการชำระเงินล่าช้า ทางโครงการจะขอเก็บค่าปรับเป็นดอกเบี้ย ร้อยละ 15 ต่อปี ของยอดนั้นๆ',
                    textAlign: pw.TextAlign.left,
                    maxLines: 1,
                    style: pw.TextStyle(
                        font: ttf,
