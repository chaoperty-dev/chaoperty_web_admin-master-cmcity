...
class Pdfgen_Agreementnim4place {
//////////---------------------------------------------------->(เอกสารแนบท้ายสัญญาหมายเลข 2)

  static void exportPDF_Agreementnim4place(
      context,
          ...
          return [
            ...
            pw.Column(children: [
              pw.Row(children: [
                Textx(
                    value:
                        '            คู่สัญญาทั้งสองฝ่ายได้ตกลงทำเอกสารแนบท้ายฉบับนี้ขึ้น เพื่อเป็นหลักฐานสำคัญว่า ทั้ง 2 ฝ่ายตกลงเพิ่มเติมเงื่อนไขและข้อ',
                    font: ttf),
              ]),
              pw.Row(children: [
                Textx(
                    value:
                        'ตกลงตามสัญญาในส่วนของสัญญาเช่าอาคาร ข้อ 2.1 ดังต่อไปนี้',
                    font: ttf),
              ]),
              pw.SizedBox(height: 2 * PdfPageFormat.mm),
              pw.Row(children: [
                Textx(
                    value:
                        '            1. ผู้ให้เช่าตกลงยินยอม     อนุญาติให้     ผู้เช่าเข้าทำการ     ปรับปรุงตกแต่งสถานที่พื้นที่เช่า     ตามสัญญาได้ตั้งแต่วันที่',
                    font: ttf),
              ]),
              pw.Row(children: [
                labeledLine1(
                    value: '${formatThaiDate(Form_sdate)}', font: ttf, flex: 1),
                Textx(value: 'ถึงวันที่', font: ttf),
                labeledLine1(
                    value: '${formatThaiDate(Form_ldate)}', font: ttf, flex: 1),
                Textx(
                    value: 'และในช่วงเวลาดังกล่าวผู้ให้เช่าให้คำมั่นสัญญา',
                    font: ttf),
              ]),
              pw.Row(children: [
                Textx(
                    value:
                        'และตกลงว่าจะไม่ทำการเรียกเก็บค่าเช่าจากผู้เช่าแต่ประการใดแต่ทั้งนี้  ผู้เช่าตกลงและให้คำมั่นสัญญาว่า  ผู้เช่าตกลงรับผิดชอบชำระ',
                    font: ttf),
              ]),
              pw.Row(children: [
                Textx(
                    value:
                        'ค่าไฟฟ้า ค่าน้ำประปา (ตามเงื่อนไขและข้อตกลงตามสัญญาเช่าทรัพย์สินที่อ้างถึง)และค่าใช้จ่ายอื่นๆ ที่เกิดขึ้นในระหว่างที่ผู้เช่าทำการ',
                    font: ttf),
              ]),
              pw.Row(children: [
                Textx(
                    value:
                        'ปรับปรุงตกแต่งสถานที่พื้นที่เช่าดังกล่าวข้างต้น โดยผู้เช่าตกลงชำระให้แก่ผู้เช่าให้เช่ากำหนด',
                    font: ttf),
              ]),
            ]),
            pw.SizedBox(height: 2 * PdfPageFormat.mm),
            pw.Column(children: [
              pw.Row(children: [
                Textx(
                    value:
                        '            ในกรณีสุดวิสัยไม่ว่าด้วยเหตุใดภายหลังจากวันที่ผู้เช่าได้รับการครอบครองทรัพย์สินที่เช่า ผู้เช่ามีสิทธิเข้าปรับปรุงตกแต่งเพื่อ',
                    font: ttf),
              ]),
              pw.Row(children: [
                Textx(
                    value:
                        'ใช้สิทธิประโยชน์ในทรัพย์สินที่เช่าตามระยะเวลาที่กำหนดไว้ในสัญญาเช่าทรัพย์สิน  หากผู้เช่าไม่สามารถเปิดธุรกิจได้ทั้งหมด  หรือส่วน',
                    font: ttf),
              ]),
              pw.Row(children: [
                Textx(
                    value:
                        'หนึ่งส่วนใด  หรือมีการแก้ไขปรับปรุงแบบ  ซึ่งทำให้ทรัพย์สินที่เช่าเปลี่ยนแปลงไปไม่ว่าจะเป็นสาระสำคัญหรือไม่ก็ตาม  และทำให้วัตถุ',
                    font: ttf),
              ]),
              pw.Row(children: [
                Textx(
                    value:
                        'ประสงค์ในการนำทรัพย์สินออกให้เช่าเปลี่ยนแปลงไป  ผู้เช่ายินยอมเสียค่าปรับเป็นวันละ 1,000.00 บาท (หนึ่งพันบาทถ้วน)  ยกเว้นมี',
                    font: ttf),
              ]),
              pw.Row(children: [
                Textx(
                    value:
                        'เหตุจำเป็น ผู้เช่าต้องมีหนังสือแจ้งเป็นลายลักษณ์อักษรให้ผู้เช่าทราบถึงความจำเป็นนั้นก่วนล่วงหน้า',
                    font: ttf),
              ]),
            ]),
            pw.NewPage(),
            pw.Column(children: [
              pw.Row(children: [
                Textx(
                    value:
                        '            2. ผู้เช่าตกลงทำการชำระค่าเช่าและค่าบริการ เป็นการล่วงหน้าให้แก่ผู้ให้เช่าภายในทุกวันที่ 5 ของทุก ๆ เดือน ดังนี้',
                    font: ttf),
              ]),
              // pw.Column(
              //   children: [
                  ...
                  for (int i = 0; i < filteredListchao.length; i++) ...[
                    pw.Row(
                      ...
                      children: [
                        Textx(
                          value:
                              '                  2.${i + 1} ${filteredListchao[i].expname}',
                          font: ttf,
                        ),
                      ],
                    ),
            ...
            pw.Column(children: [
              pw.Row(children: [
                Textx(
                    value:
                        '            ทั้งนี้ อัตราค่าเช่าตามข้อ 2. ดังกล่าวข้างต้น ไม่ได้รวมภาษีต่าง ๆ ที่เกี่ยวข้องตามที่กฎหมายกำหนดอันเป็นภาระและหน้าที่',
                    font: ttf),
              ]),
              pw.Row(children: [
                Textx(
                    value:
                        'ผู้เช่า และการปรับขึ้นอัตราค่าเช่าตามข้อ 2. ผู้เช่ารับทราบและตกลงว่าเป็นสิทธิเด็ดขาดของผู้ให้เช่าแต่เพียงฝ่ายเดียวในการพิจารณา',
                    font: ttf),
              ]),
              pw.Row(children: [
                Textx(
