          ...
          return [
              ...
              children: [
                ...
                pw.Expanded(
                    ...
                    child: pw.Container(
                      ...
                      child: pw.Text(
                        (Form_tax.toString().isNotEmpty) ? "$Form_tax" : " - ",
                        textAlign: pw.TextAlign.center,
                        style: pw.TextStyle(
                          color: Colors_pd,
                          fontSize: font_Size,
              ...
              children: [
                ...
                pw.Expanded(
                    ...
                    child: pw.Container(
                      ...
                      child: pw.Text(
                        (Form_tel.toString().isNotEmpty) ? "$Form_tel" : " - ",
                        textAlign: pw.TextAlign.center,
                        style: pw.TextStyle(
                          color: Colors_pd,
                          fontSize: font_Size,
              ...
              children: [
                ...
                pw.Expanded(
                    ...
                    child: pw.Container(
                      ...
                      child: pw.Text(
                        (Form_zn.toString().isNotEmpty) ? "$Form_zn" : " - ",
                        textAlign: pw.TextAlign.center,
                        style: pw.TextStyle(
                          color: Colors_pd,
                          fontSize: font_Size,
              ...
              children: [
                ...
                pw.Expanded(
                    ...
                    child: pw.Container(
                      ...
                      child: pw.Text(
                        (Form_ln.toString().isNotEmpty) ? "$Form_ln" : " - ",
                        textAlign: pw.TextAlign.center,
                        style: pw.TextStyle(
                          color: Colors_pd,
                          fontSize: font_Size,
                ...
                pw.Expanded(
                    ...
                    child: pw.Container(
                      ...
                      child: pw.Text(
                        (Form_qty.toString().isNotEmpty) ? "$Form_qty" : " - ",
                        textAlign: pw.TextAlign.center,
                        style: pw.TextStyle(
                          color: Colors_pd,
                          fontSize: font_Size,
              ...
              children: [
                ...
                pw.Expanded(
                    ...
                    child: pw.Container(
                      ...
                      child: pw.Text(
                        (Form_areaaddrx.toString().isNotEmpty)
                            ? "$Form_areaaddrx"
                            : " - ",
                        textAlign: pw.TextAlign.center,
                        style: pw.TextStyle(
            ...
            for (int index = 0; index < quotxSelectModels.length; index++) ...[
              () {
                ...
                final bool hasAmtTy =
                    model.amt_ty != null && model.amt_ty!.isNotEmpty;
                    ...
                    children: [
                      ...
                      pw.Expanded(
                        ...
                        child: pw.Container(
                          ...
                          child: pw.Center(
                            child: pw.Text(
                              (model.sdate == null || model.ldate == null)
                                  ? '00-00-0000'
                        ...
                        child: pw.Container(
                          ...
                          child: pw.Center(
                            child: pw.Text(
                              model.qty == null
                                  ? '0.00'
                                  : nFormat.format(double.parse(model.qty)),
                              style: pw.TextStyle(
                                fontSize: font_Size,
                                font: ttf,
                                color: Colors_pd,
                        ...
                        child: pw.Container(
                          ...
                          child: pw.Center(
                            child: pw.Text(
                              model.total == null
                                  ? '0.00'
                                  : nFormat.format(double.parse(model.total)),
                              style: pw.TextStyle(
                                fontSize: font_Size,
                                font: ttf,
                                color: Colors_pd,
                      ...
                      pw.Expanded(
                        ...
                        child: pw.Container(
                          ...
                          child: pw.Align(
                            ...
                            child: pw.Text(
                              model.total == null || model.term == null
                                  ? '0.00'
                                  : nFormat.format(int.parse(model.term) *
                ...
                return pw.Column(
                  children: List.generate(groupedAmt.length, (i) {
                    ...
                    final bool isLastGroup = (i == groupedAmt.length - 1);

                    if (isLastGroup) {
                      dateEnd = DateTime.parse('${model.ldate} 00:00:00');
                    } else {
                      if (unitserValue == 1) {
                        ...
                        dateEnd = DateTime(newYear, newMonth, dateStart.day)
                            .subtract(Duration(days: 1));
                      } else if (unitserValue == 3) {
                        dateEnd = dateStart.add(Duration(days: 7 * count - 1));
                      } else if (unitserValue == 4) {
                        dateEnd = dateStart.add(Duration(days: count - 1));
                      }
                    }

                    currentStartDate = dateEnd.add(Duration(days: 1));
                      ...
                      children: [
                        ...
                        pw.Expanded(
                          ...
                          child: pw.Container(
                            ...
                            child: pw.Center(
                              child: pw.Text(
                                nFormat.format(double.parse(model.qty ?? '0')),
                                style: pw.TextStyle(
                                  fontSize: font_Size,
                                  font: ttf,
                                  color: Colors_pd,
